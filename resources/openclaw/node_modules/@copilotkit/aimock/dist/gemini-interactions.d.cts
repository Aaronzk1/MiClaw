...
//#region src/gemini-interactions.d.ts
...
declare function geminiInteractionsToCompletionRequest(req: InteractionsRequest): ChatCompletionRequest;
declare function handleGeminiInteractions(req: http$1.IncomingMessage, res: http$1.ServerResponse, raw: string, fixtures: Fixture[], journal: Journal, defaults: HandlerDefaults, setCorsHeaders: (res: http$1.ServerResponse) => void): Promise<void>;
//#endregion
export { geminiInteractionsToCompletionRequest, handleGeminiInteractions };
//# sourceMappingURL=gemini-interactions.d.cts.map