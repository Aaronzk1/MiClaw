...
function getDefaultSteeringPath(options = {}) {
...
function hasAlwaysIncludedFrontmatter(text) {
...
export async function installKiroSteering(steeringPath, options = {}) {
...
export async function uninstallKiroSteering(steeringPath, options = {}) {
    const resolvedSteeringPath = steeringPath ?? getDefaultSteeringPath(options);
...
export async function doctorKiroSteering(steeringPath, options = {}) {
    const resolvedSteeringPath = steeringPath ?? getDefaultSteeringPath(options);
    const existing = await readInstructionFile(resolvedSteeringPath);
    if (!existing.exists) {
        return {
