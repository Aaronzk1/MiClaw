export type CompactionKind = "head-tail-omission" | "middle-truncation" | "tail-truncation" | "hashed-middle-clip" | "git-diff-hunk-clip" | "inspection-package-lock-summary" | "inspection-large-document-summary" | "github-actions-command-list-omission" | "github-actions-log-signal-filter" | "github-status-check-rollup-omission" | "no-omit-head-tail-passthrough" | "no-omit-char-clip-passthrough" | "no-omit-domain-passthrough";
...
export declare function createPassthroughCompactionMetadata(...kinds: CompactionKind[]): CompactionMetadata;
