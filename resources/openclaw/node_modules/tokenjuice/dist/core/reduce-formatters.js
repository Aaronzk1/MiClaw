import { createCompactionMetadata, createPassthroughCompactionMetadata, mergeCompactionMetadata } from "./compaction-metadata.js";
...
export function rewriteGitStatusLines(lines) {
    let section = null;
...
export function rewriteSearchLines(lines, noOmit = false) {
    const compactions = [];
...
export function rewriteGitDiffLines(lines, noOmit = false) {
    const rewritten = [];
    const compactions = [];
...
export function rewriteGhLines(lines, input, noOmit = false) {
