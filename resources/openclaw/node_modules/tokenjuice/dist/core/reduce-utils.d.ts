...
export declare function clipMiddleWithHash(text: string, maxChars: number, noOmit?: boolean): {
    text: string;
    compaction?: CompactionMetadata;
};
export declare function compactWholeJsonText(rawText: string, maxChars: number, noOmit?: boolean): {
    text: string;
    compaction?: CompactionMetadata;
} | null;
