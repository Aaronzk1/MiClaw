...
function appendCapturedChunk(current, chunk, limitBytes) {
...
export async function runWrappedCommand(argv, opts = {}) {
    if (argv.length === 0) {
    ...
    return await new Promise((resolve, reject) => {
        ...
        let stderr = { text: "", bytes: 0, truncated: false };
        let combined = { text: "", bytes: 0, truncated: false };
