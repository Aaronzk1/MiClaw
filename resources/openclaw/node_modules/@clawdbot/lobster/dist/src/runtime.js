...
export async function runPipeline({ pipeline, registry, stdin, stdout, stderr, env, mode = "human", input, cwd = undefined, llmAdapters = undefined, signal = undefined, dryRun = false, }) {
    if (dryRun) {
