...
var convertCliToOptions = (cli) => {
  const rawArgs = _nullishCoalesce(cli.rawArgs, () => ( []));
  const gitignoreExplicitlyEnabled = rawArgs.some((a) => a === "--gitignore" || a === "-g");
  const gitignoreExplicitlyDisabled = rawArgs.some((a) => a === "--no-gitignore");
  const gitignore = gitignoreExplicitlyEnabled ? true : gitignoreExplicitlyDisabled ? false : void 0;
  const result = {
    ...
    formatsNames: _finder.parseFormatsNames.call(void 0, cli.formatsNames),
    list: cli.list,
...
//# sourceMappingURL=chunk-Q6UWWJAR.js.map