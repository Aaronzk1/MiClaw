...
import { u as hasUsableCustomProviderApiKey } from "./model-auth-DVfmdW0b.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-recovery-hint-Cyy5KXVJ.js";
import { t as applyAuthChoiceLoadedPluginProvider } from "./provider-auth-choice-BFwaol_x.js";
import "./provider-auth-choice-preference-BD8UmMfD.js";
...
async function normalizeLegacyChoice(authChoice, params) {
	...
	const { normalizeLegacyOnboardAuthChoice } = await import("./auth-choice-legacy-DNp4yMa6.js");
...
async function normalizeTokenProviderChoice(params) {
	...
	const { normalizeApiKeyTokenProviderAuthChoice } = await import("./auth-choice.apply.api-providers-DOMCtPPk.js");
...
async function formatDeprecatedProviderChoiceError(authChoice, params) {
	...
	const { resolveManifestDeprecatedProviderAuthChoice } = await import("./provider-auth-choices-C_eGCfHU.js");
