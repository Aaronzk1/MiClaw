import { n as createParallelFreeWebSearchProviderBase, t as createParallelWebSearchProviderBase } from "./parallel-web-search-provider.shared-DS9va3Vo.js";
import "./parallel-search-normalize-BrqPQAw_.js";
...
let parallelWebSearchRuntimePromise;
function loadParallelWebSearchRuntime() {
...
const ParallelSearchSchema = {
	...
	properties: {
		...
		client_model: {
			type: "string",
			description: "The identifier of the LLM model making this tool call (e.g. 'claude-opus-4-7', 'gpt-5.5', 'gemini-3.1-pro'). Pass the exact active model slug verbatim; never shorten or substitute a family alias like 'gpt-5'. Lets Parallel tailor default settings for your model's capabilities.",
...
let parallelFreeWebSearchRuntimePromise;
function loadParallelFreeWebSearchRuntime() {
