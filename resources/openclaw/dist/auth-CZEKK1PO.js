...
import { c as loadAuthProfileStoreForRuntime } from "./store-C8spD0DG.js";
import { a as resolvePluginSetupRegistry, i as resolvePluginSetupProvider } from "./setup-registry-HspW94zx.js";
...
import { i as removeProviderAuthProfilesWithLock, r as promoteAuthProfileInOrder, s as upsertAuthProfileWithLock } from "./profiles-BMWtmBgj.js";
import { n as clearAuthProfileCooldown } from "./usage-K7-k2Oys.js";
...
import { c as resolveKnownAgentId, d as updateConfig, o as loadValidConfigOrThrow } from "./shared-B3B7qn2l.js";
import { a as restorePriorAgentsDefaultsModelUnlessOptIn, i as resolveProviderMatch, n as applyProviderAuthConfigPatch, r as pickAuthMethod, t as applyDefaultModel } from "./provider-auth-choice-helpers-CewNDs91.js";
...
import { r as repairCodexRuntimePluginInstallForModelSelection } from "./codex-runtime-plugin-install-BG-9pbTp.js";
import { r as repairCopilotRuntimePluginInstallForModelSelection } from "./copilot-runtime-plugin-install-DCkDR2Sd.js";
...
async function runProviderAuthMethod(params) {
	...
	const result = await params.method.run({
		...
		openUrl: async (url) => {
			const { openUrl } = await import("./onboard-helpers-CfAsmV3U.js");
			await openUrl(url);
		},
