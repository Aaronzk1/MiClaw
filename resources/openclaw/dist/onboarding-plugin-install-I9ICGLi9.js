...
import { a as installPluginFromNpmSpec, i as installPluginFromNpmPackArchive } from "./install-DzhyqmuT.js";
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-BuLcDN4V.js";
...
async function installPluginFromClawHubSpecWithProgress(params) {
	...
	try {
		const { installPluginFromClawHub } = await import("./clawhub-CCyYIg6s.js");
