...
import { c as resolveAgentExplicitModelPrimary, d as resolveAgentModelFallbacksOverride } from "./agent-scope-MrLta7Pq.js";
...
import { a as restoreCurrentPluginMetadataSnapshotState, o as setCurrentPluginMetadataSnapshot, r as getCurrentPluginMetadataSnapshot, t as captureCurrentPluginMetadataSnapshotState } from "./current-plugin-metadata-snapshot-CfA_n2Nc.js";
import { r as createConfigIO } from "./io-Gi7-pyU-.js";
import { r as resolveProviderIdForAuth } from "./provider-auth-aliases-BNZrcvHv.js";
import { o as shouldEnableShellEnvFallback, t as getShellEnvAppliedKeys } from "./shell-env-BRMtst4r.js";
...
import { M as evaluateStoredCredentialEligibility, i as ensureAuthProfileStoreWithoutExternalProfiles, v as loadPersistedAuthProfileStore } from "./store-C8spD0DG.js";
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DEeoLRlM.js";
import { j as resolveProviderSyntheticAuthWithPlugin } from "./provider-runtime-CJtW0nDR.js";
...
import { o as resolveProfileUnusableUntilForDisplay } from "./usage-K7-k2Oys.js";
import { g as resolveConfiguredModelRef, i as buildModelAliasIndex, y as resolveModelRefFromString } from "./model-selection-shared-b32cUYts.js";
import { i as modelKey, o as normalizeProviderId } from "./model-selection-normalize-roKDxQ9_.js";
import { b as resolveProviderEnvAuthLookupMaps, d as isNonSecretApiKeyMarker, f as isOAuthApiKeyMarker, y as listProviderEnvAuthLookupKeys } from "./model-auth-markers-Sq8HdQFX.js";
...
import { h as resolveUsableCustomProviderApiKey, o as getCustomProviderApiKey } from "./model-auth-DVfmdW0b.js";
import "./workspace-B0bmoo98.js";
import { c as resolveKnownAgentId, r as ensureFlagCompatibility } from "./shared-B3B7qn2l.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-4xis_1sG.js";
...
const providerUsageRuntimeLoader = createLazyImportLoader(() => import("./provider-usage-CXxqdJwe.js"));
...
const listProbeRuntimeLoader = createLazyImportLoader(() => import("./list.probe-DNTy2jP4.js"));
...
async function modelsStatusCommand(opts, runtime) {
	...
	try {
		...
		if (missingProvidersInUse.length > 0) {
			const { buildProviderAuthRecoveryHint } = await import("./provider-auth-recovery-hint-CR_fgJE2.js");
			runtime.log("");
