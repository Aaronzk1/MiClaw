...
import { i as isPersistentCrestodianOperation, n as executeCrestodianOperation } from "./operations-B8_IoqaI.js";
import { r as loadCrestodianOverview, t as formatCrestodianOverview } from "./overview-DagrVfRA.js";
import { r as resolveCrestodianOperation } from "./dialogue-UeqAeF95.js";
...
async function runCrestodian(opts = {}, runtime = defaultRuntime) {
	...
	const runInteractiveTui = opts.runInteractiveTui ?? (await import("./tui-backend-Derp_SJM.js")).runCrestodianTui;
	opts.onReady?.();
