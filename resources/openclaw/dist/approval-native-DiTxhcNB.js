...
import { a as buildApprovalReactionPendingContentForRequest } from "./approval-reaction-runtime-BQQ1cR5g.js";
...
import { i as signalApprovalAuth, r as getSignalApprovalApprovers } from "./format-B-0MMYcV.js";
...
const signalApprovalCapability = createChannelApprovalCapability({
	...
	nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
		...
		load: async () => (await import("./approval-handler.runtime-3SoGEY9s.js")).signalApprovalNativeRuntime
	})
});
