...
import { D as runWithDiagnosticTraceContext, v as createDiagnosticTraceContext } from "./diagnostic-events-Chmz2PSy.js";
...
import { a as AUTH_RATE_LIMIT_SCOPE_NODE_PAIRING, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, t as AUTH_RATE_LIMIT_SCOPE_BOOTSTRAP_TOKEN } from "./auth-rate-limit-Bwr29t2Y.js";
import { a as hasForwardedRequestHeaders, c as checkBrowserOrigin, i as authorizeWsControlUiGatewayConnect, o as isLocalDirectRequest, r as authorizeHttpGatewayConnect, s as withSerializedRateLimitAttempt } from "./auth-DXSWhsnk.js";
...
import { c as buildDeviceAuthPayloadV3, l as normalizeDeviceMetadataForAuth, s as buildDeviceAuthPayload } from "./client-C2g2lFC5.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient, t as isBrowserOperatorUiClient } from "./message-channel-BiOeMu0l.js";
...
import { c as updatePairedNodeMetadata, d as sameNodeApprovalSurfaceSet, f as sameNodePermissionSurface, n as getPairedNode, s as requestNodePairing, u as normalizeNodeApprovalSurfaceList } from "./node-pairing-BjnR-f-1.js";
import { i as recordRemoteNodeInfo, o as refreshRemoteNodeBins } from "./remote-DoOmoEi1.js";
...
import { a as incrementPresenceVersion, n as getHealthCache, r as getHealthVersion, t as buildGatewaySnapshot } from "./health-state-Cha0Tz7F.js";
	...
	const handleMessage = async (data) => {
		...
		try {
			...
			if (!client) {
				...
				if (role === "node") {
					let reconciliation;
					const pairedNode = await getPairedNode(connectParams.device?.id ?? connectParams.client.id);
					try {
						reconciliation = await reconcileNodePairingOnConnect({
							...
							requestPairing: async (input) => {
								try {
									...
									if (error instanceof NodePairingRateLimitError && pairedNode) return null;
									throw error;
								}
							}
						});
