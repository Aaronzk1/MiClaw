...
import { i as LEGACY_SECRETREF_ENV_MARKER_PREFIX, p as parseLegacySecretRefEnvMarker } from "./types.secrets-_0JOMGE5.js";
...
import { L as resolveNormalizedProviderModelMaxTokens } from "./io-Gi7-pyU-.js";
import { u as collectConfiguredModelRefs } from "./channel-env-var-names-B6Cczraa.js";
import { t as splitTrailingAuthProfile } from "./model-ref-profile-BIKs-96s.js";
import { r as getBundledChannelPlugin, s as hasBundledChannelPackageSetupFeature } from "./bundled-DcYUmgzC.js";
import { n as formatConfigIssueLines } from "./issue-format-CwCoGNbt.js";
import { r as normalizeTalkSection } from "./talk-CQIjIARC.js";
import { o as callGateway } from "./call-B5-GYOlf.js";
import { o as runPluginSetupConfigMigrations } from "./setup-registry-HspW94zx.js";
...
import { i as noteOpencodeProviderOverrides, n as noteImplicitFallbackClobberWarnings, o as stripUnknownConfigKeys } from "./doctor-config-analysis-BUgmtVDJ.js";
import { a as legacyRuntimeModelAliasRequiresRuntimePolicy, i as migrateLegacyXSearchConfig, o as listLegacyRuntimeModelProviderAliases, r as migrateLegacyWebSearchConfig, s as migrateLegacyRuntimeModelRef } from "./legacy-config-migrations-DpcSqkVJ.js";
...
import { t as runDoctorConfigPreflight } from "./doctor-config-preflight-CBEUIQa-.js";
import { n as applyChannelDoctorCompatibilityMigrations, t as migrateLegacyConfig } from "./legacy-config-migrate-TV9KmmFR.js";
...
async function loadAndMaybeMigrateDoctorConfig(params) {
	...
	const { applyPluginAutoEnable } = await import("./plugin-auto-enable-Bm6cIZBX.js");
	...
	const { collectPluginToolAllowlistWarnings } = await import("./plugin-tool-allowlist-warnings-nkVmdUWd.js");
	...
	if (hasConfiguredChannels) {
		const channelDoctor = await import("./channel-doctor-CdbWx726.js");
	...
	const { repairHooksTokenReuseGatewayAuth } = await import("./hooks-token-reuse-repair-B_Pm2vQ6.js");
	...
	if (shouldRepair) {
		const { runDoctorRepairSequence } = await import("./repair-sequencing-BMSusabO.js");
		...
		const { collectDoctorPreviewNotes } = await import("./preview-warnings-D7-Z4v3i.js");
