...
import { i as resolveSessionFilePath, s as resolveSessionTranscriptPathInDir } from "./paths-NEwU8m3X.js";
...
import { d as listActiveEmbeddedRunSessionIds, f as listActiveEmbeddedRunSessionKeys } from "./run-state-BYGFyjne.js";
...
import { g as resolveGatewaySessionStoreTarget } from "./session-utils-CHNCuY8a.js";
...
async function markStartupOrphanedMainSessionsForRecovery(params) {
	...
	for (const storePath of await resolveRestartRecoveryStorePaths(params)) await updateSessionStore(storePath, (store) => {
		for (const [sessionKey, entry] of Object.entries(store)) {
