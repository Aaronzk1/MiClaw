...
import "./anthropic-payload-policy-ZFzBdZJv.js";
...
function createDeepSeekV4OpenAICompatibleThinkingWrapper(params) {
	...
	return (model, context, options) => {
		...
		const disabled = isDisabledDeepSeekV4ThinkingLevel(params.thinkingLevel);
		const effort = disabled ? void 0 : resolveReasoningEffort(params.thinkingLevel);
		const patchedOptions = {
			...options,
			reasoning: disabled ? "off" : params.thinkingLevel,
		};
		return streamWithPayloadPatch(underlying, model, context, patchedOptions, (payload) => {
			if (disabled) {
...
//#endregion
export { promoteStandalonePlainTextToolCallMessage as C, extractStandalonePlainTextToolCallText as S, scrubOverCapPlainTextToolCallMessage as T, sanitizeGoogleThinkingPayload as _, createGoogleThinkingStreamWrapper as a, createToolStreamWrapper as b, createThinkingOnlyFinalTextWrapper as c, isGoogleGemini3FlashModel as d, isGoogleGemini3ProModel as f, resolveGoogleGemini3ThinkingLevel as g, isOpenAICompatibleThinkingEnabled as h, createGoogleThinkingPayloadWrapper as i, defaultToolStreamExtraParams as l, isGoogleThinkingRequiredModel as m, createAnthropicThinkingPrefillPayloadWrapper as n, createPayloadPatchStreamWrapper as o, isGoogleGemini3ThinkingLevelModel as p, createDeepSeekV4OpenAICompatibleThinkingWrapper as r, createPlainTextToolCallCompatWrapper as s, composeProviderStreamWrappers as t, isGoogleGemini25ThinkingBudgetModel as u, stripInvalidGoogleThinkingBudget as v, normalizePlainTextToolCallStreamEvents as w, createZaiToolStreamWrapper as x, stripTrailingAnthropicAssistantPrefillWhenThinking as y };
