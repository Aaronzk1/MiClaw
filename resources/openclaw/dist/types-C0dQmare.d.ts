import { i as OpenClawConfig, pt as TalkProviderConfig, sn as CliBackendConfig, t as ConfigFileSnapshot, xn as SilentReplyConversationType } from "./types.openclaw-DBHlrrVj.js";
import { t as ChatType } from "./chat-type-B6XXSSnm.js";
import { o as AgentModelConfig } from "./types.provider-request-B-0pnpMf.js";
...
import { M as MemoryCitationsMode, S as ToolLoopDetectionConfig } from "./types.tools-DZk2axJU.js";
import { G as TtsConfig, K as TtsMode, U as ResolvedTtsPersona, W as TtsAutoMode, Z as TtsProvider } from "./types.slack-BZcmYWK8.js";
import { E as ThinkingLevel, b as StreamFn, f as Model, l as ImageContent, n as Api, r as AssistantMessage } from "./types-DgdzO8vP.js";
import { d as ModelProviderAuthMode, f as ModelProviderConfig, l as ModelMediaInputConfig, o as ModelCompatConfig } from "./types.models-O5iWV16x.js";
import { d as PluginKind, f as UnifiedModelCatalogEntry, g as PluginConfigUiHint, p as UnifiedModelCatalogKind } from "./manifest-registry-C_uwfra_.js";
...
import { t as ConfigWriteAfterWrite } from "./runtime-snapshot-CcFZMnjT.js";
import { g as ConfigMutationBase, w as ConfigReplaceResult } from "./config-DwYD2fKb.js";
import { y as resolveStateDir } from "./paths-DMbAnCAA.js";
...
import { t as ModelProviderRequestTransportOverrides$1 } from "./provider-request-config-Q7J3DPH_.js";
import { n as requestHeartbeat, t as HeartbeatRunResult } from "./heartbeat-wake-B5gXOqCt.js";
import { d as ElevatedLevel, f as ReasoningLevel, g as VerboseLevel, h as TraceLevel, m as ThinkingCatalogEntry, p as ThinkLevel, s as CommandNormalizeOptions, u as ShouldHandleTextCommandsParams } from "./commands-registry.types-BqG8c-dd.js";
import { _ as PromptImageOrderEntry, a as SourceReplyDeliveryMode, h as InputProvenance, m as UserTurnTranscriptRecorder, n as GetReplyOptions, o as TypingController, r as PartialReplyPayload, s as ReplyPayload } from "./types-M6XXnA3B.js";
import { Er as AgentTool, Vr as StreamFn$1, kr as AgentToolResult, wr as AgentMessage } from "./index-DleKJdko.js";
import { a as CommandTurnKind, d as InboundEventKind, i as CommandTurnContext, n as MsgContext, t as FinalizedMsgContext } from "./templating-DE3RVG5z.js";
...
import { i as SkillTelemetrySource, r as SkillSnapshot, t as SkillCommandSpec } from "./types-DcV72yaA.js";
...
import { a as SessionEntry, i as SessionContextBudgetStatus, n as GroupKeyResolution, o as SessionScope$1, s as SessionSystemPromptReport, t as CliSessionBinding } from "./types-B4Q1rYPc.js";
...
import { _ as completeSimple } from "./llm-B1MSEcsd.js";
...
import { r as AnyAgentTool } from "./common-Nuz33yLC.js";
import { c as OAuthCredential, i as AuthProfileCredential, s as AuthProfileStore, t as ApiKeyCredential } from "./types-Mr2-MEbO.js";
import { t as ModelCatalogEntry } from "./model-catalog.types-Cq4tDx8k.js";
import { Ai as AuthStorage, Ci as ModelRegistry$1 } from "./index-CpWsDSRW.js";
import { n as RuntimeEnv } from "./runtime-Bxifh4bY.js";
import { s as LogLevel } from "./subsystem-CfQVin8T.js";
import { C as ResolvedProviderAuth } from "./model-auth-B5m-IsF4.js";
...
import { N as resolveAgentDir, P as resolveAgentWorkspaceDir } from "./agent-scope-D96soN7N.js";
import { a as createAckReactionHandle, c as shouldAckReaction, d as resolveAgentIdentity, f as resolveEffectiveMessagesConfig, o as removeAckReactionAfterReply, p as resolveHumanDelayConfig, s as removeAckReactionHandleAfterReply } from "./ack-reactions-B7-bvBKk.js";
import { _ as resolveSessionFilePath, a as patchSessionEntry, b as resolveStorePath, d as updateSessionStoreEntry, f as upsertSessionEntry, i as listSessionEntries, m as loadSessionStore, r as getSessionEntry, u as updateSessionStore } from "./session-key-DPs44Vwq.js";
import { f as MediaUnderstandingProvider } from "./types-CYL5O5NV.js";
import { n as HistoryMediaEntry, t as HistoryEntry } from "./history.types-Bc8mCALh.js";
import { o as enqueueSystemEvent } from "./system-events-BPINBuYn.js";
...
import { _ as ImageGenerationSourceImage, c as ImageGenerationOutputFormat, f as ImageGenerationProviderOptions, h as ImageGenerationResolution, i as ImageGenerationNormalization, l as ImageGenerationProvider, n as ImageGenerationBackground, p as ImageGenerationQuality, r as ImageGenerationIgnoredOverride, t as GeneratedImageAsset } from "./types-BncZP6Hi.js";
import { d as VideoGenerationResolution, n as VideoGenerationIgnoredOverride, o as VideoGenerationNormalization, p as VideoGenerationSourceAsset, s as VideoGenerationProvider, t as GeneratedVideoAsset } from "./types-BWrPgwyR.js";
import { c as MusicGenerationProvider, f as MusicGenerationSourceImage, o as MusicGenerationNormalization, r as MusicGenerationIgnoredOverride, s as MusicGenerationOutputFormat, t as GeneratedMusicAsset } from "./types-BgrsB15F.js";
...
import { b as SecretInputMode, n as GatewayRequestHandler } from "./types-DF3JY91V.js";
import { a as onAgentEvent, n as AgentEventPayload, r as AgentEventStream } from "./agent-events-BDhJsqOa.js";
import { a as shouldLogVerbose } from "./globals-BL1_NohW.js";
import { t as HookEntry } from "./types-BCpQVPCb.js";
import { a as MediaUnderstandingRuntime } from "./runtime-types-u2-SEFKl.js";
import { P as MessageReceipt } from "./types-9QhajxKc.js";
import { _ as chunkTextWithMode, g as chunkText, h as chunkMarkdownTextWithMode, m as chunkMarkdownText, n as ChannelOutboundAdapter, p as chunkByNewline, v as resolveChunkMode, y as resolveTextChunkLimit } from "./outbound.types-BmR_QRXQ.js";
import { r as EmbeddingProviderAdapter } from "./embedding-providers-DDk0eFII.js";
import { f as MemoryPluginRuntime, o as MemoryFlushPlanResolver, p as MemoryPromptSectionBuilder, r as MemoryCorpusSupplement, s as MemoryPluginCapability } from "./memory-state-Dn2N2W5-.js";
import { i as MemoryEmbeddingProviderAdapter } from "./memory-embedding-providers-DkPGGFtP.js";
import { Et as PluginHookToolKind, J as PluginHookHandlerMap, Kt as PluginJsonValue, N as PluginHookBeforeToolCallEvent, Tt as PluginHookToolInputKind, Ut as PluginNextTurnInjection, Wt as PluginNextTurnInjectionEnqueueResult, an as ReplyDispatchBeforeDeliver, cn as ReplyDispatcher, fn as PluginHookBeforeAgentStartResult, in as PluginHookBeforeToolCallResult, nn as PluginApprovalResolution, on as ReplyDispatchKind, sn as ReplyDispatchRuntimeInfo, tt as PluginHookName, wt as PluginHookToolContext } from "./hook-types-Ciec6sPw.js";
import { t as OperatorScope } from "./operator-scopes-Phea7r7e.js";
import { t as ChannelPlugin } from "./types.plugin-BIHyhl5u.js";
import { Ut as TalkTransport, a as DiagnosticEventPayload, i as DiagnosticEventMetadata, o as DiagnosticEventPrivateData, r as DiagnosticEventInput } from "./diagnostic-events-twf54f2t.js";
import { o as TranscriptSourceProvider$1 } from "./provider-types-us6uoOu0.js";
import { a as PluginConversationBindingResolvedEvent, n as PluginConversationBindingRequestParams, r as PluginConversationBindingRequestResult, t as PluginConversationBinding } from "./conversation-binding.types-CYNWpeLp.js";
import { a as ResponsePrefixContext, s as TypingCallbacks } from "./reply-prefix-DO5vojx6.js";
import { n as ReadChannelAllowFromStoreForAccount$1, r as UpsertChannelPairingRequestForAccount$1 } from "./pairing-store.types-H6ac1LYY.js";
import { a as MatchesMentionWithExplicit$1, i as MatchesMentionPatterns$1, t as BuildMentionRegexes$1 } from "./mentions.types-k4SAk2-J.js";
import { n as RecordInboundSession$1, t as InboundLastRouteUpdate } from "./session.types-BCEl-vX2.js";
import { c as SessionBindingRecord } from "./session-binding.types-BbT2v6Ty.js";
import { t as hasControlCommand } from "./command-detection-CWFBgfWi.js";
import { t as ResolveMarkdownTableMode } from "./markdown-tables.types-RhgdT2cV.js";
import { t as convertMarkdownTables } from "./tables-BBMGs0qO.js";
import { i as buildAgentSessionKey, o as resolveAgentRoute } from "./resolve-route-DuPqx_qX.js";
import { t as buildPairingReply } from "./pairing-messages-BaQ_5GWu.js";
...
import { n as resolveChannelGroupPolicy, r as resolveChannelGroupRequireMention } from "./group-policy-YT6YISF5.js";
import { n as createInboundDebouncer, r as resolveInboundDebounceMs } from "./inbound-debounce-DqbMg11W.js";
import { r as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-pUtyEXB1.js";
import { a as OutboundDeliveryQueuePolicy, n as DurableFinalDeliveryRequirement, r as DurableFinalDeliveryRequirements, t as DeliverOutboundPayloadsParams } from "./deliver-BPjI1fqF.js";
import { i as createChannelReplyPipeline, n as CreateChannelReplyPipelineParams } from "./reply-pipeline-CycNTHH7.js";
...
//#endregion
export { OpenClawPluginService as $, runBeforeToolCallHook as $a, REALTIME_VOICE_AUDIO_FORMAT_PCM16_24KHZ as $i, PluginRuntime as $n, normalizeTtsAutoMode as $o, CommandSessionMetadataChange as $r, GenerateVideoParams as $s, ProviderModelSelectedContext as $t, OpenClawPluginDefinition as A, AgentHarnessDeliveryDefaults as Aa, ProviderRuntimePluginHandle as Ac, CodexAppServerToolResultEvent as Ai, ProviderResolvePromptOverlayContext as An, LlmCompleteParams as Ao, ConversationFacts as Ar, ChannelIngressQueueCompletedRecord as As, ProviderAuthOptionBag as At, OpenClawPluginModule as B, PreemptiveCompactionRoute as Ba, EmbeddedAgentRunResult as Bc, CliBackendThinkingLevel as Bi, ProviderTransportTurnState as Bn, DetachedTaskFinalizeParams as Bo, formatInboundEnvelope as Br, WebFetchProviderContext as Bs, ProviderCatalogResult as Bt, OpenClawPluginApi as C, RealtimeTranscriptionSessionCallbacks as Ca, resolveSimpleCompletionSelectionForAgent as Cc, PluginSessionTurnUnscheduleByTagParams as Ci, ProviderReplaySanitizeMode as Cn, SubagentEndReason as Co, AccessFacts as Cr, OpenClawPluginHookOptions as Cs, PluginTranscriptsSourceProviderEntry as Ct, OpenClawPluginCliRegistrar as D, AgentHarnessAttemptResult as Da, ProviderThinkingPolicyContext as Dc, CodexAppServerExtensionContext as Di, ProviderResolveAuthProfileIdContext as Dn, TranscriptRewriteResult as Do, ChannelTurnRecordOptions as Dr, ChannelIngressQueue as Ds, ProviderAuthKind as Dt, OpenClawPluginCliContext as E, AgentHarnessAttemptParams as Ea, ProviderDefaultThinkingPolicyContext as Ec, PluginTrustedToolPolicyRegistration as Ei, ProviderReplayToolCallIdMode as En, TranscriptRewriteRequest as Eo, ChannelTurnDroppedHistoryOptions as Er, OpenClawPluginToolOptions as Es, ProviderAuthDoctorHintContext as Et, OpenClawPluginHttpRouteHandler as F, AgentHarnessSupport as Fa, ProviderResolveExternalOAuthProfilesContext as Fc, CliBackendPlugin as Fi, ProviderRuntimeProviderConfig as Fn, BoundTaskFlowsRuntime as Fo, SupplementalContextFacts as Fr, emitSessionTranscriptUpdate as Fs, ProviderBuiltInModelSuppressionResult as Ft, OpenClawPluginNodeInvokePolicyApprovalRuntime as G, BeforeToolCallPolicyDiagnosticState as Ga, normalizeHeartbeatToolResponse as Gc, AgentToolResultMiddlewareContext as Gi, RealtimeTranscriptionProviderPlugin as Gn, TaskRunCancelResult as Go, DispatchReplyWithBufferedBlockDispatcher$1 as Gr, WebSearchCredentialResolutionSource as Gs, ProviderDiscoveryOrder as Gt, OpenClawPluginNodeHostCommand as H, normalizeUsage as Ha, MessagingToolSourceReplyPayload as Hc, PluginTextReplacement as Hi, ProviderValidateReplayTurnsContext as Hn, TaskFlowDetail as Ho, resolveEnvelopeFormatOptions as Hr, WebFetchProviderPlugin as Hs, ProviderCreateStreamFnContext as Ht, OpenClawPluginHttpRouteMatch as I, AgentHarnessSupportContext as Ia, ProviderResolveSyntheticAuthContext as Ic, CliBackendPrepareExecutionContext as Ii, ProviderSanitizeReplayHistoryContext as In, BoundTaskRunsRuntime as Io, ChannelBotLoopProtectionFacts as Ir, onSessionTranscriptUpdate as Is, ProviderCacheTtlEligibilityContext as It, OpenClawPluginNodeInvokeTransportResult as J, ToolOutcomeObserver as Ja, AgentToolResultMiddlewareOptions as Ji, TranscriptSourceProvider as Jn, ResolvedTtsConfig as Jo, ReplyDispatcherWithTypingOptions as Jr, WebSearchProviderPlugin as Js, ProviderExtraParamsForTransportResult as Jt, OpenClawPluginNodeInvokePolicyContext as K, DeferredPluginToolApproval as Ka, AgentToolResultMiddlewareEvent as Ki, RealtimeVoiceProviderPlugin as Kn, TaskRunDetail as Ko, DispatchReplyWithDispatcher as Kr, WebSearchProviderContext as Ks, ProviderDiscoveryResult as Kt, OpenClawPluginHttpRouteParams as L, CompactEmbeddedAgentSessionParams as La, ProviderSyntheticAuthResult as Lc, CliBackendPreparedExecution as Li, ProviderSystemPromptContributionContext as Ln, PluginRuntimeTaskFlows as Lo, recordChannelBotPairLoopAndCheckSuppression as Lr, PluginWebFetchProviderEntry as Ls, ProviderCapabilities as Lt, OpenClawPluginGatewayRuntimeScopeSurface as M, AgentHarnessResultClassification as Ma, ProviderExternalAuthProfile as Mc, CliBackendAuthEpochMode as Mi, ProviderResolveUsageAuthContext as Mn, LlmCompleteUsage as Mo, InboundMediaFacts as Mr, ChannelIngressQueueFailedRecord as Ms, ProviderBuildMissingAuthMessageContext as Mt, OpenClawPluginHostedMediaResolver as N, AgentHarnessSideQuestionParams as Na, ProviderExternalOAuthProfile as Nc, CliBackendNativeToolMode as Ni, ProviderResolveWebSocketSessionPolicyContext as Nn, PluginRuntimeCore as No, PreparedChannelTurn as Nr, ChannelIngressQueuePruneOptions as Ns, ProviderBuildUnknownModelHintContext as Nt, OpenClawPluginCommandDefinition as O, AgentHarnessCompactParams as Oa, ProviderThinkingProfile as Oc, CodexAppServerExtensionFactory as Oi, ProviderResolveDynamicModelContext as On, LlmCompleteCaller as Oo, ChannelTurnResult as Or, ChannelIngressQueueClaim as Os, ProviderAuthMethod as Ot, OpenClawPluginHttpRouteAuth as P, AgentHarnessSideQuestionResult as Pa, ProviderResolveExternalAuthProfilesContext as Pc, CliBackendNormalizeConfigContext as Pi, ProviderResolvedUsageAuth as Pn, RuntimeLogger as Po, RunChannelTurnParams as Pr, ChannelIngressQueueRecord as Ps, ProviderBuiltInModelSuppressionContext as Pt, OpenClawPluginSecurityAuditContext as Q, requestDeferredPluginToolApproval as Qa, REALTIME_VOICE_AUDIO_FORMAT_G711_ULAW_8KHZ as Qi, CreatePluginRuntimeOptions as Qn, TTS_AUTO_MODES as Qo, GetReplyFromConfig as Qr, WebSearchRuntimeMetadataContext as Qs, ProviderFollowupFallbackRouteResult as Qt, OpenClawPluginHttpRouteUpgradeHandler as R, EmbeddedRunAttemptParams as Ra, EmbeddedAgentCompactResult as Rc, CliBackendResolveExecutionArgs as Ri, ProviderToolSchemaDiagnostic as Rn, PluginRuntimeTaskRuns as Ro, EnvelopeFormatOptions as Rr, PluginWebSearchProviderEntry as Rs, ProviderCatalogContext as Rt, OpenClawPluginAgentEventsApi as S, RealtimeTranscriptionSession as Sa, prepareSimpleCompletionModelForAgent as Sc, PluginSessionTurnScheduleParams as Si, ProviderReplayPolicyContext as Sn, IngestResult as So, resolveChannelInboundSupplementalContext as Sr, OpenClawPluginActiveModelContext as Ss, PluginTextTransformRegistration as St, OpenClawPluginCliCommandDescriptor as T, AgentHarness as Ta, provider_runtime_d_exports as Tc, PluginToolMetadataRegistration as Ti, ProviderReplaySessionState as Tn, TranscriptRewriteReplacement as To, ChannelTurnAdmission as Tr, OpenClawPluginToolFactory as Ts, ProviderAuthContext as Tt, OpenClawPluginNodeInvokeApprovalDecision as U, AgentRuntimePlan as Ua, HEARTBEAT_RESPONSE_TOOL_NAME as Uc, PluginTextTransforms as Ui, ProviderWebSocketSessionPolicy as Un, TaskFlowView as Uo, finalizeInboundContext as Ur, WebFetchProviderToolDefinition as Us, ProviderDeferSyntheticProfileAuthContext as Ut, OpenClawPluginNodeCliFeatureOptions as V, NormalizedUsage as Va, MessagingToolSend as Vc, CliBundleMcpMode as Vi, ProviderUsageAuthToken as Vn, DetachedTaskLifecycleRuntime as Vo, formatInboundFromLabel as Vr, WebFetchProviderId as Vs, ProviderCreateEmbeddingProviderContext as Vt, OpenClawPluginNodeInvokePolicy as W, BuildAgentRuntimePlanParams as Wa, HeartbeatToolResponse as Wc, AgentToolResultMiddleware as Wi, ProviderWrapStreamFnContext as Wn, TaskRunAggregateSummary as Wo, settleReplyDispatcher as Wr, WebFetchRuntimeMetadataContext as Ws, ProviderDiscoveryContext as Wt, OpenClawPluginRunContextApi as X, hasBeforeToolCallPolicy as Xa, AgentToolResultMiddlewareRuntime as Xi, UnifiedModelCatalogProviderPlugin as Xn, TtsConfigResolutionContext as Xo, createReplyDispatcherWithTyping as Xr, WebSearchProviderToolDefinition as Xs, ProviderFetchUsageSnapshotContext as Xt, OpenClawPluginReloadRegistration as Y, getBeforeToolCallPolicyDiagnosticState as Ya, AgentToolResultMiddlewareResult as Yi, UnifiedModelCatalogProviderContext as Yn, ResolvedTtsModelOverrides as Yo, createReplyDispatcher as Yr, WebSearchProviderSetupContext as Ys, ProviderFailoverErrorContext as Yt, OpenClawPluginSecurityAuditCollector as Z, isToolWrappedWithBeforeToolCallHook as Za, OpenClawAgentToolResult as Zi, VideoGenerationProviderPlugin as Zn, resolveEffectiveTtsConfig as Zo, DispatchFromConfigResult as Zr, WebSearchProviderToolExecutionContext as Zs, ProviderFollowupFallbackRouteContext as Zt, MigrationSummary as _, RealtimeVoiceToolResultOptions as _a, PreparedSimpleCompletionModel as _c, PluginSessionAttachmentResult as _i, ProviderPrepareRuntimeAuthContext as _n, ContextEngineOperation as _o, FinalizeChannelInboundContextResult as _r, SpeechTelephonySynthesisRequest as _s, PluginRealtimeVoiceProviderEntry as _t, ImageGenerationProviderPlugin as a, RealtimeVoiceBridgeEvent as aa, EmbeddedRunTrigger as ac, ProviderResolveConfigApiKeyContext as ai, ProviderNormalizeToolSchemasContext as an, ContextEngineFactoryContext as ao, hasVisibleChannelTurnDispatch as ar, SpeechProviderConfiguredContext as as, PluginCommandContext as at, OpenClawGatewayDiscoveryService as b, RealtimeTranscriptionProviderId as ba, completeWithPreparedSimpleCompletionModel as bc, PluginSessionSchedulerJobHandle as bi, ProviderReasoningOutputModeContext as bn, ContextEngineRuntimeContext as bo, filterChannelInboundSupplementalContext as br, TtsDirectiveParseResult as bs, PluginSetupAutoEnableProbe as bt, MigrationDetection as c, RealtimeVoiceCloseReason as ca, AgentInternalEvent as cc, PluginAgentEventSubscriptionRegistration as ci, ProviderPlugin as cn, resolveContextEngineOwnerPluginId as co, DurableInboundReplyDeliveryParams as cr, SpeechProviderPrepareSynthesisContext as cs, PluginCommandResult as ct, MigrationItemKind as d, RealtimeVoiceProviderConfiguredContext as da, EmbeddedBlockChunker as dc, PluginRunContextPatch as di, ProviderPluginWizard as dn, CompactResult as do, BuildChannelInboundEventContextAsyncParams as dr, SpeechProviderResolveTalkConfigContext as ds, PluginEmbeddingProvider as dt, RealtimeVoiceAudioFormat as ea, GenerateVideoRuntimeResult as ec, CommandContext as ei, ProviderModernModelPolicyContext as en, setBeforeToolCallDiagnosticsEnabled as eo, SubagentRunParams as er, SpeechDirectiveTokenParseContext as es, OpenClawPluginServiceContext as et, MigrationItemStatus as f, RealtimeVoiceProviderId as fa, AgentStreamParams as fc, PluginRuntimeLifecycleRegistration as fi, ProviderPluginWizardModelPicker as fn, ContextEngine as fo, BuildChannelInboundEventContextParams as fr, SpeechProviderResolveTalkOverridesContext as fs, PluginInteractiveHandlerRegistration as ft, MigrationProviderPreparation as g, RealtimeVoiceToolCallEvent as ga, AgentSimpleCompletionSelection as gc, PluginSessionAttachmentParams as gi, ProviderPrepareExtraParamsContext as gn, ContextEngineMaintenanceResult as go, FinalizeChannelInboundContextParams as gr, SpeechSynthesisTarget as gs, PluginRealtimeTranscriptionProviderEntry as gt, MigrationProviderPlugin as h, RealtimeVoiceTool as ha, ExecToolDefaults as hc, PluginSessionActionResult as hi, ProviderPrepareDynamicModelContext as hn, ContextEngineInfo as ho, FinalizeChannelInboundContextAsyncParams as hr, SpeechSynthesisStreamResult as hs, PluginLogger as ht, AgentPromptSurfaceKind as i, RealtimeVoiceBridgeCreateRequest as ia, CurrentInboundPromptContext as ic, ProviderNormalizeConfigContext as ii, ProviderNormalizeResolvedModelContext as in, ContextEngineFactory as io, hasFinalChannelTurnDispatch as ir, SpeechProviderConfig as is, OpenClawPluginSessionWorkflowApi as it, OpenClawPluginGatewayMethod as j, AgentHarnessResetParams as ja, ProviderSystemPromptContribution as jc, CodexAppServerToolResultHandlerResult as ji, ProviderResolveTransportTurnStateContext as jn, LlmCompleteResult as jo, DispatchedChannelTurnResult as jr, ChannelIngressQueueEnqueueResult as js, ProviderAuthResult as jt, OpenClawPluginConfigSchema as k, AgentHarnessCompactResult as ka, ProviderRuntimeModel as kc, CodexAppServerExtensionRuntime as ki, ProviderResolveNonInteractiveApiKeyParams as kn, LlmCompleteMessage as ko, CommandFacts as kr, ChannelIngressQueueClaimRef as ks, ProviderAuthMethodNonInteractiveContext as kt, MigrationItem as l, RealtimeVoiceProviderCapabilities as la, OPENCLAW_RUNTIME_CONTEXT_CUSTOM_TYPE as lc, PluginControlUiDescriptor as li, ProviderPluginCatalog as ln, AssembleResult as lo, DurableInboundReplyDeliveryResult as lr, SpeechProviderPreparedSynthesis as ls, PluginConfigMigration as lt, MigrationProviderContext as m, RealtimeVoiceRole as ma, ExecElevatedDefaults as mc, PluginSessionActionRegistration as mi, ProviderPreferRuntimeResolvedModelContext as mn, ContextEngineHostRequirements as mo, ChannelInboundSupplementalResolutionOptions as mr, SpeechSynthesisStreamRequest as ms, PluginInteractiveRegistration as mt, AgentPromptGuidance as n, RealtimeVoiceBridge as na, GenerateImageRuntimeResult as nc, ProcessToolDefaults as ni, ProviderNonInteractiveApiKeyResult as nn, AgentHarnessTaskRuntimeScope as no, kernel_d_exports as nr, SpeechListVoicesRequest as ns, OpenClawPluginSessionControlsApi as nt, MediaUnderstandingProviderPlugin as o, RealtimeVoiceBrowserSession as oa, RunEmbeddedAgentParams as oc, PluginAgentEventEmitParams as oi, ProviderNormalizeTransportContext as on, registerContextEngine as oo, resolveChannelTurnDispatchCounts as or, SpeechProviderId as os, PluginCommandDiagnosticsSession as ot, MigrationPlan as p, RealtimeVoiceProviderResolveConfigContext as pa, ClientToolDefinition as pc, PluginSessionActionContext as pi, ProviderPluginWizardSetup as pn, ContextEngineHostCapability as po, BuiltChannelInboundEventContext as pr, SpeechSynthesisRequest as ps, PluginInteractiveHandlerResult as pt, OpenClawPluginNodeInvokePolicyResult as q, HookContext as qa, AgentToolResultMiddlewareHarness as qi, SpeechProviderPlugin as qn, TaskRunView as qo, ReplyDispatcherOptions as qr, WebSearchProviderId as qs, ProviderExtraParamsForTransportContext as qt, AgentPromptGuidanceEntry as r, RealtimeVoiceBridgeCallbacks as ra, resolveAgentTimeoutMs as rc, ProviderApplyConfigDefaultsContext as ri, ProviderNormalizeModelIdContext as rn, resolveEmbeddedAgentRuntime as ro, recordDroppedChannelInboundHistory as rr, SpeechModelOverridePolicy as rs, OpenClawPluginSessionStateApi as rt, MigrationApplyResult as s, RealtimeVoiceBrowserSessionCreateRequest as sa, PromptMode as sc, PluginAgentEventEmitResult as si, ProviderOAuthProfileIdRepair as sn, resolveContextEngine as so, DurableInboundReplyDeliveryOptions as sr, SpeechProviderOverrides as ss, PluginCommandHandler as st, AGENT_PROMPT_SURFACE_KINDS as t, RealtimeVoiceBargeInOptions as ta, GenerateImageParams as tc, CommandHandler as ti, ProviderNonInteractiveApiKeyCredentialParams as tn, wrapToolWithBeforeToolCallHook as to, SubagentRunResult as tr, SpeechDirectiveTokenParseResult as ts, OpenClawPluginSessionApi as tt, MigrationItemAction as u, RealtimeVoiceProviderConfig as ua, BlockReplyChunking as uc, PluginRunContextGetParams as ui, ProviderPluginDiscovery as un, BootstrapResult as uo, deliverInboundReplyWithMessageSendContext as ur, SpeechProviderResolveConfigContext as us, PluginConfigValidation as ut, MusicGenerationProviderPlugin as v, RealtimeTranscriptionProviderConfig as va, PreparedSimpleCompletionModelForAgent as vc, PluginSessionExtensionProjection as vi, ProviderPreparedRuntimeAuth as vn, ContextEngineProjection as vo, buildChannelInboundEventContext as vr, SpeechVoiceOption as vs, PluginRegistrationMode as vt, OpenClawPluginChannelRegistration as w, RealtimeTranscriptionSessionCreateRequest as wa, augmentModelCatalogWithProviderPlugins as wc, PluginSessionTurnUnscheduleByTagResult as wi, ProviderReplaySessionEntry as wn, SubagentSpawnPreparation as wo, AssembledChannelTurn as wr, OpenClawPluginToolContext as ws, ProviderAugmentModelCatalogContext as wt, OpenClawPluginAgentApi as x, RealtimeTranscriptionProviderResolveConfigContext as xa, prepareSimpleCompletionModel as xc, PluginSessionSchedulerJobRegistration as xi, ProviderReplayPolicy as xn, IngestBatchResult as xo, finalizeChannelInboundContext as xr, ResolvedProviderRuntimeAuth as xs, PluginSpeechProviderEntry as xt, OpenClawGatewayDiscoveryAdvertiseContext as y, RealtimeTranscriptionProviderConfiguredContext as ya, SimpleCompletionModelOptions as yc, PluginSessionExtensionRegistration as yi, ProviderReasoningOutputMode as yn, ContextEnginePromptCacheInfo as yo, filterChannelInboundQuoteContext as yr, TtsDirectiveOverrides as ys, PluginSetupAutoEnableContext as yt, OpenClawPluginLifecycleApi as z, EmbeddedRunAttemptResult as za, EmbeddedAgentRunMeta as zc, CliBackendResolveExecutionArgsContext as zi, ProviderTransformSystemPromptContext as zn, PluginRuntimeTasks as zo, formatAgentEnvelope as zr, WebFetchCredentialResolutionSource as zs, ProviderCatalogOrder as zt };