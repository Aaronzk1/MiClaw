...
import { d as redactToolPayloadTextWithConfig, o as redactSensitiveFieldValueWithConfig, r as isSensitiveFieldKey } from "./redact-DduLliKq.js";
...
import { _ as uniqueStrings, l as normalizeStringEntries, u as normalizeStringEntriesLower } from "./string-normalization-WNUDCpXX.js";
...
import { i as resolveEffectivePluginActivationState, r as normalizePluginsConfigWithResolver } from "./manifest-registry-BywZIeAq.js";
import "./agent-scope-MrLta7Pq.js";
import { n as normalizeAccountId } from "./account-id-Df9e41E6.js";
import { i as resolveAgentContextLimits } from "./agent-scope-config-CgCYpZfK.js";
import { r as getCurrentPluginMetadataSnapshot } from "./current-plugin-metadata-snapshot-CfA_n2Nc.js";
import { i as loadPluginMetadataSnapshot, n as isPluginMetadataSnapshotCompatible } from "./plugin-metadata-snapshot-Ctk9Oarq.js";
...
import { P as getCompactionProvider } from "./registry-CYsBNH12.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-BnyQREr6.js";
import { F as isCacheEnabled, I as resolveCacheTtlMs, N as createExpiringMapCache } from "./store-load-C4uq6Lrq.js";
import { n as sanitizeInlineImageBase64 } from "./inline-image-data-url-CwAAaSvc.js";
import { h as redactTranscriptMessage, m as isTranscriptOnlyOpenClawAssistantModel, p as isTranscriptOnlyOpenClawAssistantMessage$1 } from "./transcript-Cw-EfeYD.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DTn-thXR.js";
import "./transcript-jsonl-CD0KPCG0.js";
import { K as validateProviderReplayTurnsWithPlugin, V as sanitizeProviderReplayHistoryWithPlugin, w as resolveProviderCacheTtlEligibility } from "./provider-runtime-CJtW0nDR.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, n as extractToolResultId, t as extractToolCallsFromAssistant } from "./tool-call-id-DOLZ5Kkz.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing, n as repairToolUseResultPairing, r as sanitizeToolCallInputs, t as makeMissingToolResult } from "./session-transcript-repair-B17NYGhL.js";
import { i as streamSimple, o as getApiProvider } from "./stream-4H1GSjKe.js";
import { at as SettingsManager, s as DefaultResourceLoader } from "./sessions-BTpdzjUa.js";
import { n as SUMMARIZATION_OVERHEAD_TOKENS } from "./compaction-planning-BOByCD2w.js";
...
import { t as log$3 } from "./logger-B8odRltZ.js";
import { c as isAnthropicModelRef, s as isAnthropicFamilyCacheTtlEligible } from "./proxy-2a5P4QqJ.js";
...
import { i as mergePreparedUserTurnMessageForRuntime } from "./user-turn-transcript-BKLlhoCh.js";
import { b as loadEmbeddedAgentMcpConfig } from "./agent-bundle-mcp-runtime-Bf36JLIh.js";
import { a as resolveEffectiveCompactionMode, r as applyAgentCompactionSettingsFromConfig } from "./agent-settings-Btt05WNB.js";
import { j as resolveChannelPromptCapabilities } from "./agent-tools.before-tool-call-BkVrW03y.js";
...
import { c as sanitizeSessionMessagesImages, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, r as validateGeminiTurns, u as downgradeOpenAIReasoningBlocks, x as sanitizeGoogleTurnOrdering } from "./embedded-agent-helpers-7sfpu1OT.js";
import { r as createBoundaryAwareStreamFnForModel } from "./provider-stream-FsgXx-aW.js";
import { f as supportsAutomaticThreadBindingSpawn, u as resolveThreadBindingSpawnPolicy } from "./thread-bindings-policy-DZGWBoLX.js";
import { n as createAnthropicVertexStreamFnForModel } from "./simple-completion-transport-B3UDWDI2.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { t as buildConfiguredAgentSystemPrompt } from "./system-prompt-config-CVau6v04.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, t as DEFAULT_MAX_LIVE_TOOL_RESULT_CHARS, u as truncateToolResultMessage } from "./tool-result-truncation-BiAgZIVd.js";
import { a as setRawSessionAppendMessage, c as readTranscriptFileState, i as getRawSessionAppendMessage, l as writeTranscriptFileAtomic, o as TranscriptFileState } from "./transcript-rewrite-CFSWWhu_.js";
import { a as resolveUserTimezone, t as formatDateStamp } from "./date-time-CcWivhrg.js";
import { a as computeAdaptiveChunkRatioWithWorker, d as shouldAllowProviderOwnedThinkingReplay, i as buildHistoryPrunePlanWithWorker, l as providerRequiresSignedThinking, n as resolveContextWindowTokens$1, r as summarizeInStages, t as createAgentToolResultMiddlewareRunner, u as resolveTranscriptPolicy } from "./tool-result-middleware-B3Hdp_cV.js";
import { o as isGooglePromptCacheEligible } from "./extra-params-CQOwTzpP.js";
...
function getAssistantMessageErrorText(event) {
	const errorMessage = event.error.errorMessage;
	return typeof errorMessage === "string" ? errorMessage : "";
}
async function retryStreamWithoutThinking(outer, retry) {
	...
	try {
		...
		for await (const chunk of resolved) {
			if (isAssistantMessageErrorEvent(chunk)) {
				if (shouldRecoverAnthropicThinkingErrorMessage(getAssistantMessageErrorText(chunk), sessionMeta)) if (yieldedOutput) log$3.warn(`[session-recovery] Anthropic thinking error occurred after streaming began; skipping retry to avoid duplicate chunks: sessionId=${sessionMeta.id}`);
				else {
...
//#endregion
export { isRealConversationMessage as A, buildStreamErrorAssistantMessage as B, sanitizeSessionHistory as C, limitHistoryTurns as D, getHistoryLimitFromSessionKey as E, readLastCacheTtlTimestamp as F, dropThinkingBlocks as G, collectRuntimeChannelCapabilities as H, logRuntimeToolSchemaQuarantine as I, createPreparedEmbeddedAgentSettingsManager as J, wrapAnthropicStreamWithRecovery as K, guardSessionManager as L, consumeCompactionSafeguardCancelReason as M, setCompactionSafeguardCancelReason as N, buildEmbeddedExtensionFactories as O, isCacheTtlEligibleProvider as P, repairSessionFileIfNeeded as R, normalizeAssistantReplayContent as S, buildEmbeddedMessageActionDiscoveryInput as T, assessLastAssistantMessage as U, buildUsageWithNoCost as V, dropReasoningFromHistory as W, resolveEmbeddedAgentBaseStreamFn as _, flushPendingToolResultsAfterIdle as a, trackSessionManagerAccess as b, AGENT_RESERVED_TOOL_NAMES as c, collectRegisteredToolNames as d, toSessionToolAllowlist as f, resolveEmbeddedAgentApiKey as g, describeEmbeddedAgentStreamStrategy as h, dedupeDuplicateUserMessagesForCompaction as i, readPostCompactionContext as j, hasMeaningfulConversationContent as k, collectAllowedToolNames as l, buildEmbeddedSystemPrompt as m, rotateTranscriptFileAfterCompaction as n, mapThinkingLevel as o, applySystemPromptToSession as p, isZeroUsageEmptyStopAssistantTurn as q, shouldRotateCompactionTranscript as r, normalizeContextTokenBudget as s, rotateTranscriptAfterCompaction as t, collectCoreBuiltinToolNames as u, resolveEmbeddedAgentStreamFn as v, validateReplayTurns as w, createEmbeddedAgentResourceLoader as x, prewarmSessionFile as y, STREAM_ERROR_FALLBACK_TEXT as z };
