...
import { o as resolveAgentEffectiveModelPrimary } from "./agent-scope-MrLta7Pq.js";
...
import { c as hasRuntimeAvailableProviderAuth } from "./model-auth-DVfmdW0b.js";
import "./workspace-B0bmoo98.js";
import { t as loadModelCatalogForBrowse } from "./model-catalog-browse-CKW2B8Bh.js";
import { n as resolveVisibleModelCatalog, t as isCodexRoutableOpenAIPlatformCatalogEntry } from "./model-catalog-visibility-BYLLfZkR.js";
...
function modelCatalogEntryHasUnknownSecretRefAvailability(cfg, entry) {
	const providerId = normalizeProviderId(entry.provider);
	const apiKey = (Object.entries(cfg.models?.providers ?? {}).find(([id]) => normalizeProviderId(id) === providerId)?.[1])?.apiKey;
	return apiKey === "secretref-managed" || isSecretRef(apiKey) && apiKey.source !== "env";
}
...
async function buildPublicModelsListEntry(params) {
	...
	if (modelCatalogEntryHasUnknownSecretRefAvailability(params.cfg, params.entry)) return {
		...publicEntry,
		available: false
	};
