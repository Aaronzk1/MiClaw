...
import { l as measureDiagnosticsTimelineSpan, s as emitDiagnosticsTimelineEvent, u as measureDiagnosticsTimelineSpanSync } from "./plugin-metadata-snapshot-Ctk9Oarq.js";
...
import { a as isOperatorUiClient, n as isGatewayCliClient, o as isWebchatClient } from "./message-channel-BiOeMu0l.js";
import "./sessions-D6zZvoxX.js";
import { n as estimateBase64DecodedBytes } from "./base64-l6yrCyHc.js";
import { o as resolveMirroredTranscriptText, s as appendSessionTranscriptMessage } from "./transcript-Cw-EfeYD.js";
...
import { _ as stripEnvelopeFromMessage, c as readSessionMessageByIdAsync, d as readSessionMessagesAsync, g as readSessionTranscriptIndex, i as readRecentSessionMessagesAsync, n as capArrayByJsonBytes } from "./session-utils.fs-D_8-X4jl.js";
...
import { i as stripInlineDirectiveTagsForDisplay, n as sanitizeReplyDirectiveId } from "./directive-tags-Dg-nkHHo.js";
import { a as getSessionDefaults, b as resolveSessionModelRef, h as resolveGatewayModelSupportsImages, l as loadGatewaySessionRow, o as listAgentsForGateway, p as resolveDeletedAgentIdFromSessionKey, t as buildGatewaySessionInfo, u as loadSessionEntry } from "./session-utils-CHNCuY8a.js";
...
import { t as dispatchInboundMessage } from "./dispatch-DO0Fpkbp.js";
import { r as createUserTurnTranscriptRecorder } from "./user-turn-transcript-BKLlhoCh.js";
import { r as getAgentScopedMediaLocalRoots, t as appendLocalMediaParentRoots } from "./local-roots-BqdtViGS.js";
import { n as assertLocalMediaAllowed, t as LocalMediaAccessError } from "./local-media-access-Bw3v5URj.js";
import { i as normalizeReplyPayloadsForDelivery } from "./payloads-B4DTFTLz.js";
...
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-BQ4p-0vf.js";
import { t as rewriteTranscriptEntriesInSessionFile } from "./transcript-rewrite-CFSWWhu_.js";
import { u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-F1u3otwq.js";
import { s as augmentChatHistoryWithCliSessionImports } from "./attempt-execution.helpers-CPoC_qYr.js";
import { n as createReplyMediaPathNormalizer } from "./reply-media-paths.runtime-CgZsH182.js";
import { n as createReplyDispatcher } from "./reply-dispatcher.types-CKL81tAi.js";
import { n as isSuppressedControlReplyText } from "./control-reply-text-F2bAzr1v.js";
import { a as isChatStopCommandText, c as resolveInFlightRunSnapshot, i as boundInFlightRunSnapshotForChatHistory, l as updateChatRunProvider, o as registerChatAbortController, t as abortChatRunById } from "./chat-abort-Cu_ehtms.js";
...
import { t as logLargePayload } from "./diagnostic-payload-DELJ7QXt.js";
...
import { n as modelCatalogBrowseRequiresFullDiscovery } from "./model-catalog-browse-CKW2B8Bh.js";
import { i as projectChatDisplayMessage, n as augmentChatHistoryWithCanvasBlocks, o as projectRecentChatDisplayMessages, r as dropPreSessionStartAnnouncePairs, s as resolveEffectiveChatHistoryMaxChars } from "./chat-display-projection-Bv2HD4Rr.js";
import { t as stageSandboxMedia } from "./stage-sandbox-media-B8GL16pJ.js";
import { a as resolveChatAttachmentMaxBytes, i as parseMessageWithAttachments, n as MediaOffloadError, r as UnsupportedAttachmentError, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-CATn3nI8.js";
import { i as createManagedOutgoingImageBlocks, n as attachManagedOutgoingImagesToMessage, r as cleanupManagedOutgoingImageRecords } from "./managed-image-attachments-DW7RaUWq.js";
import { r as resolveSessionHistoryTailReadOptions } from "./session-history-state-B5plVodV.js";
...
async function buildChatMetadataResult(params) {
	const [{ buildModelsListResult }, { buildCommandsListResult }] = await Promise.all([import("./models-list-result-rQnrqKJL.js"), import("./commands-list-result-Bhv70M6Z.js")]);
...
async function buildChatStartupMetadataResult(params) {
	...
	try {
		const { buildModelsListResult } = await import("./models-list-result-rQnrqKJL.js");
...
const chatHandlers = {
	...
	"chat.message.get": async ({ params, respond, context }) => {
		...
		const resolved = await readSessionMessageByIdAsync(sessionId, storePath, entry?.sessionFile, messageId);
		if (!resolved.found) {
			respond(true, {
				ok: false,
				unavailableReason: "not_found"
					...
					if (!agentRunStarted) {
						...
						if (btwReplies.length > 0 && btwText) {
							...
							const finalPayloads = await normalizeWebchatReplyMediaPathsForDisplay({
								...
								agentId,
								accountId,
								payloads: appendedWebchatAgentMedia ? [] : deliveredReplies.filter((entryItem) => entryItem.kind === "final").map((entryCandidate) => entryCandidate.payload)
							});
							const { storePath: latestStorePath, entry: latestEntry } = loadSessionEntry(sessionKey, sessionLoadOptions);
							const sessionId = latestEntry?.sessionId ?? backingSessionId ?? clientRunId;
							const resolvedTranscriptPath = resolveTranscriptPath({
...
//#endregion
export { replaceOversizedChatHistoryMessages as a, sanitizeChatSendMessageInput as c, enforceChatHistoryFinalBudget as i, buildOversizedHistoryPlaceholder as n, emitSessionsChanged as o, chatHandlers as r, hasTrackedActiveSessionRun as s, CHAT_HISTORY_MAX_SINGLE_MESSAGE_BYTES as t };
