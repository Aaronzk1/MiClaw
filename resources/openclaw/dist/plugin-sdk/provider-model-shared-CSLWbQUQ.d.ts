import { f as Model } from "./types-DgdzO8vP.js";
...
import { In as ProviderSanitizeReplayHistoryContext, On as ProviderResolveDynamicModelContext, Ql as ProviderSystemPromptContribution, Sn as ProviderReplayPolicyContext, Xl as ProviderRuntimeModel, Yl as ProviderThinkingProfile, cn as ProviderPlugin, xn as ProviderReplayPolicy, yn as ProviderReasoningOutputMode } from "./types-BVAOMoZy.js";
...
type BuildProviderReplayFamilyHooksOptions = {
  ...
  sanitizeToolCallIds?: boolean; /** Whether replay policy should strip reasoning blocks from history. */
  dropReasoningFromHistory?: boolean;
} | {
