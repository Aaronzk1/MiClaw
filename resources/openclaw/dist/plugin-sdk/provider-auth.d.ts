...
import { b as hasConfiguredSecretInput, d as SecretInput, g as SecretRefSource, y as coerceSecretRef } from "./types.secrets-rAcqRhcN.js";
import { c as OAuthCredential, i as AuthProfileCredential, l as OAuthProvider, s as AuthProfileStore } from "./types-BqOdOOQT.js";
import { Dl as listProfilesForProvider, Gl as CODEX_CLI_PROFILE_ID, Sl as removeProviderAuthProfilesWithLock, Tl as upsertAuthProfileWithLock, Tt as ProviderAuthContext, Ul as hasUsableOAuthCredential, Vl as DEFAULT_OAUTH_REFRESH_MARGIN_MS, Wl as CLAUDE_CLI_PROFILE_ID, al as ensureAuthProfileStore, bl as suggestOAuthProfileIdForLegacyDefault, gl as updateAuthProfileStoreWithLock, jt as ProviderAuthResult, ol as ensureAuthProfileStoreForLocalUpdate, qc as resolveEnvApiKey, wl as upsertAuthProfile } from "./types-BVAOMoZy.js";
import { i as omitEnvKeysCaseInsensitive, r as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-BXRNBJHg.js";
import { C as SecretInputMode } from "./types-lgjKn6Hq.js";
import { t as resolveOpenClawAgentDir } from "./agent-dir-compat-ochOeoeD.js";
import { d as isNonSecretApiKeyMarker, g as resolveNonEnvSecretRefApiKeyMarker, i as MINIMAX_OAUTH_MARKER, n as CUSTOM_LOCAL_AUTH_MARKER, u as isKnownEnvApiKeyMarker, v as resolveOAuthApiKeyMarker } from "./model-auth-markers-CdvzCfQg.js";
import { a as upsertApiKeyProfile, i as buildApiKeyCredential, n as WriteOAuthCredentialsOptions, o as writeOAuthCredentials, r as applyAuthProfileConfig, t as ApiKeyStorageOptions } from "./provider-auth-helpers-CgJ95v8U.js";
import { o as resolveRequiredHomeDir } from "./home-dir-CsTKsPTB.js";
import { a as normalizeSecretInputModeInput, c as promptSecretRefForSetup, i as normalizeApiKeyInput, n as ensureApiKeyFromOptionEnvOrPrompt, o as validateApiKeyInput, r as formatApiKeyPreview, s as resolveSecretInputModeForEnvSelection, t as ensureApiKeyFromEnvOrPrompt } from "./provider-auth-input-C5HpuBgY.js";
