...
import { G as resolveMemoryDeepDreamingConfig, K as resolveMemoryDreamingConfig, W as resolveMemoryCorePluginConfig } from "./dreaming-SqhFI2Et.js";
...
import { b as readStringParam, g as readPositiveIntegerParam, l as jsonResult, p as readFiniteNumberParam, r as asToolParamsRecord } from "./common-C4yy9V-D.js";
import { r as optionalFiniteNumberSchema, s as stringEnum } from "./typebox-DCO1JbMn.js";
...
import { b as recordShortTermRecalls } from "./short-term-promotion-DuBGW686.js";
		...
		execute: ({ cfg, agentId }) => async (_toolCallId, params) => {
			...
			const outcome = await runMemorySearchToolWithDeadline({
				...
				run: async (deadlineSignal) => {
					...
					const memory = shouldQueryMemory ? await runUnavailablePhase("memory", async () => await getMemoryManagerContext({
						cfg,
						agentId
					})) : null;
