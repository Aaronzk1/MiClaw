...
import { c as createMSTeamsHttpError, n as refreshMSTeamsDelegatedTokens } from "./oauth.token-WsrnLWSm.js";
...
async function loadSdkModules() {
	sdkAppPromise ??= Promise.all([import("./dist-DCVnNDZe.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-m7dmJ-Tv.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]).then(([apps, api]) => ({
		App: apps.App,
