import{m as e,p as t}from"./lit-runtime-BImxIzGR.js";import{o as n}from"./string-coerce-Dt6Kt5Fx.js";import{G as r,c as i,ht as a,l as o,mt as s,q as c}from"./index-B6YtUsIL.js";import{n as l,t as u}from"./channel-config-extras-MkoBBgM9.js";function d(e,t){let n=e;for(let e of t){if(!n)return null;let t=a(n);if(t===`object`){let t=n.properties??{};if(typeof e==`string`&&t[e]){n=t[e];continue}let r=n.additionalProperties;if(typeof e==`string`&&r&&typeof r==`object`){n=r;continue}return null}if(t===`array`){if(typeof e!=`number`)return null;n=(Array.isArray(n.items)?n.items[0]:n.items)??null;continue}return null}return n}function f(e,t){return l(e,t)??{}}var p=[`groupPolicy`,`streamMode`,`dmPolicy`];function m(t){let n=p.flatMap(e=>e in t?[[e,t[e]]]:[]);return n.length===0?null:e`
  ...
  `}function h(t){let n=i(t.schema),r=n.schema;if(!r)return e` <div class="callout danger">Schema unavailable. Use Raw.</div> `;let a=d(r,[`channels`,t.channelId]);if(!a)return e` <div class="callout danger">Channel config schema unavailable.</div> `;let s=f(t.configValue??{},t.channelId);return e`
  ...
  `}function w(e,t){return t?.[e]?.length??0}function T(n,r){let i=w(n,r);return i<2?t:e`<div class="account-count">Accounts (${i})</div>`}function E(i){let{props:a,discord:o,accountCountLabel:s}=i,c=x(`discord`,a);return C({title:`Discord`,subtitle:`Bot status and channel configuration.`,accountCountLabel:s,statusRows:[{label:n(`common.configured`),value:S(c)},{label:n(`common.running`),value:o?.running?n(`common.yes`):n(`common.no`)},{label:n(`common.lastStart`),value:o?.lastStartAt?r(o.lastStartAt):n(`common.na`)},{label:n(`common.lastProbe`),value:o?.lastProbeAt?r(o.lastProbeAt):n(`common.na`)}],lastError:o?.lastError,secondaryCallout:o?.probe?e`<div class="callout" style="margin-top: 12px;">
    ...
    </div>`})}function D(i){let{props:a,googleChat:o,accountCountLabel:s}=i,c=x(`googlechat`,a);return C({title:`Google Chat`,subtitle:`Chat API webhook status and channel configuration.`,accountCountLabel:s,statusRows:[{label:n(`common.configured`),value:S(c)},{label:n(`common.running`),value:o?o.running?n(`common.yes`):n(`common.no`):n(`common.na`)},{label:n(`common.credential`),value:o?.credentialSource??n(`common.na`)},{label:n(`common.audience`),value:o?.audienceType?`${o.audienceType}${o.audience?` · ${o.audience}`:``}`:n(`common.na`)},{label:n(`common.lastStart`),value:o?.lastStartAt?r(o.lastStartAt):n(`common.na`)},{label:n(`common.lastProbe`),value:o?.lastProbeAt?r(o.lastProbeAt):n(`common.na`)}],lastError:o?.lastError,secondaryCallout:o?.probe?e`<div class="callout" style="margin-top: 12px;">
          ${o.probe.ok?n(`common.probeOk`):n(`common.probeFailed`)} ·
          ${o.probe.status??``} ${o.probe.error??``}
      ...
      <button class="btn" @click=${()=>a.onRefresh(!0)}>${n(`common.probe`)}</button>
    </div>`})}function k(e){return e?e.length<=20?e:`${e.slice(0,8)}...${e.slice(-8)}`:n(`common.na`)}function A(i){let{props:a,nostr:o,nostrAccounts:c,accountCountLabel:l,profileFormState:u,profileFormCallbacks:d,onEditProfile:f}=i,p=c[0],m=o?.configured??p?.configured??!1,h=o?.running??p?.running??!1,_=o?.publicKey??p?.publicKey,v=o?.lastStartAt??p?.lastStartAt??null,y=o?.lastError??p?.lastError??null,b=c.length>1,x=u!=null,S=i=>{let a=i.publicKey,o=i.profile;return e`
      <div class="account-card">
        ...
        <div class="status-list account-card-status">
          <div>
            ...
            <span>${i.running?n(`common.yes`):n(`common.no`)}</span>
          </div>
          <div>
            <span class="label">${n(`common.configured`)}</span>
            <span>${i.configured?n(`common.yes`):n(`common.no`)}</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span
              >${i.lastInboundAt?r(i.lastInboundAt):n(`common.na`)}</span
            >
          </div>
          ${i.lastError?e` <div class="account-card-error">${i.lastError}</div> `:t}
        </div>
      </div>
    `};return e`
    <div class="card">
      ...
      ${(()=>{if(x&&d)return s({state:u,callbacks:d,accountId:c[0]?.accountId??`default`});let{name:r,displayName:i,about:a,picture:l,nip05:h}=p?.profile??o?.profile??{},g=r||i||a||l||h;return e`
      <div
  ...
  `}function j(i){let{props:a,signal:o,accountCountLabel:s}=i,c=x(`signal`,a);return C({title:`Signal`,subtitle:`signal-cli status and channel configuration.`,accountCountLabel:s,statusRows:[{label:n(`common.configured`),value:S(c)},{label:n(`common.running`),value:o?.running?n(`common.yes`):n(`common.no`)},{label:n(`common.baseUrl`),value:o?.baseUrl??n(`common.na`)},{label:n(`common.lastStart`),value:o?.lastStartAt?r(o.lastStartAt):n(`common.na`)},{label:n(`common.lastProbe`),value:o?.lastProbeAt?r(o.lastProbeAt):n(`common.na`)}],lastError:o?.lastError,secondaryCallout:o?.probe?e`<div class="callout" style="margin-top: 12px;">
          ${o.probe.ok?n(`common.probeOk`):n(`common.probeFailed`)} ·
          ${o.probe.status??``} ${o.probe.error??``}
    ...
    `:C({title:`Telegram`,subtitle:`Bot status and channel configuration.`,accountCountLabel:c,statusRows:[{label:n(`common.configured`),value:S(u)},{label:n(`common.running`),value:o?.running?n(`common.yes`):n(`common.no`)},{label:n(`common.mode`),value:o?.mode??n(`common.na`)},{label:n(`common.lastStart`),value:o?.lastStartAt?r(o.lastStartAt):n(`common.na`)},{label:n(`common.lastProbe`),value:o?.lastProbeAt?r(o.lastProbeAt):n(`common.na`)}],lastError:o?.lastError,secondaryCallout:o?.probe?e`<div class="callout" style="margin-top: 12px;">
          ${o.probe.ok?n(`common.probeOk`):n(`common.probeFailed`)} ·
          ${o.probe.status??``} ${o.probe.error??``}
        </div>`:t,configSection:g({channelId:`telegram`,props:a}),footer:e`<div class="row" style="margin-top: 12px;">
      <button class="btn" @click=${()=>a.onRefresh(!0)}>${n(`common.probe`)}</button>
    </div>`})}function P(i){let{props:a,whatsapp:o,accountCountLabel:s}=i,l=x(`whatsapp`,a),u=o?.linked===!0,d=a.whatsappQrDataUrl!=null;return C({title:`WhatsApp`,subtitle:`Link WhatsApp Web and monitor connection health.`,accountCountLabel:s,statusRows:[{label:n(`common.configured`),value:S(l)},{label:n(`common.linked`),value:o?.linked?n(`common.yes`):n(`common.no`)},{label:n(`common.running`),value:o?.running?n(`common.yes`):n(`common.no`)},{label:n(`common.connected`),value:o?.connected?n(`common.yes`):n(`common.no`)},{label:n(`common.lastConnect`),value:o?.lastConnectedAt?r(o.lastConnectedAt):n(`common.na`)},{label:n(`common.lastMessage`),value:o?.lastMessageAt?r(o.lastMessageAt):n(`common.na`)},{label:n(`common.authAge`),value:o?.authAgeMs==null?n(`common.na`):c(o.authAgeMs)}],lastError:o?.lastError,extraContent:e`
    ...
    `,configSection:g({channelId:`whatsapp`,props:a}),footer:e`<div class="row" style="margin-top: 14px; flex-wrap: wrap;">
      ${u?e`<button
          ...
          >
            ${a.whatsappBusy?n(`common.working`):n(`common.showQr`)}
          </button>`}
      ${d?e`<button
            class="btn"
            ?disabled=${a.whatsappBusy}
      ...
      <button class="btn" @click=${()=>a.onRefresh(!0)}>${n(`common.refresh`)}</button>
    </div>`})}function F(i){let a=i.snapshot?.channels,o=a?.whatsapp??void 0,s=a?.telegram??void 0,c=a?.discord??null,l=a?.googlechat??null,u=a?.slack??null,d=a?.signal??null,f=a?.imessage??null,p=a?.nostr??null,m=I(i.snapshot).map((e,t)=>({key:e,enabled:b(e,i),order:t})).toSorted((e,t)=>e.enabled===t.enabled?e.order-t.order:e.enabled?-1:1),h=!!(i.loading&&i.snapshot&&i.lastSuccessAt),g=i.snapshot?.warnings?.filter(e=>e.trim())??[];return e`
    <section class="grid grid-cols-2">
      ${m.map(e=>L(e.key,i,{whatsapp:o,telegram:s,discord:c,googlechat:l,slack:u,signal:d,imessage:f,nostr:p,channelAccounts:i.snapshot?.channelAccounts??null}))}
    </section>
    ...
    <section class="card" style="margin-top: 18px;">
      <div class="row" style="justify-content: space-between;">
        ...
        <div class="muted">
          ${i.lastSuccessAt?r(i.lastSuccessAt):n(`common.na`)}
        </div>
      </div>
      ${h?e`
...
${i.snapshot?JSON.stringify(i.snapshot,null,2):n(`channels.health.noSnapshotYet`)}
      </pre
      >
    </section>
  ...
  `}function z(e){return e?.channelMeta?.length?Object.fromEntries(e.channelMeta.map(e=>[e.id,e])):{}}function B(e,t){return z(e)[t]?.label??e?.channelLabels?.[t]??t}var V=600*1e3;function H(e){return e.lastInboundAt?Date.now()-e.lastInboundAt<V:!1}function U(e){return e.running?n(`common.yes`):H(e)?n(`common.active`):n(`common.no`)}function W(e){return e.connected===!0?n(`common.yes`):e.connected===!1?n(`common.no`):H(e)?n(`common.active`):n(`common.na`)}function G(i){let a=U(i),o=W(i);return e`
    <div class="account-card">
      <div class="account-card-header">
...
//# sourceMappingURL=channels-DzDiCwy8.js.map