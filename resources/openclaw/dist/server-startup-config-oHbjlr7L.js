...
import { A as applyConfigOverrides, f as readConfigFileSnapshotWithPluginMetadata } from "./io-Gi7-pyU-.js";
...
import { o as getActiveSecretsRuntimeSnapshot, s as getLiveSecretsRuntimeAuthStores, t as activateSecretsRuntimeSnapshotState, u as setPreparedSecretsRuntimeSnapshotRefreshContext } from "./runtime-state-B3MH_XLp.js";
import { n as evaluateGatewayAuthSurfaceStates, t as GATEWAY_AUTH_SURFACE_PATHS } from "./runtime-gateway-auth-surfaces-B6IqufiU.js";
import { i as assertGatewayAuthNotKnownWeak, n as mergeGatewayAuthConfig, r as mergeGatewayTailscaleConfig, t as ensureGatewayStartupAuth } from "./startup-auth-BtAuEBV-.js";
import { a as prepareSecretsRuntimeFastPathSnapshot, o as resolveRefreshAgentDirs } from "./runtime-fast-path-DMpi5I8r.js";
...
function createRuntimeSecretsActivator(params) {
	...
	const loadSecretsRuntime = () => {
		secretsRuntimePromise ??= import("./runtime-BzZlvYH7.js");
		return secretsRuntimePromise;
	};
	const loadAuthProfiles = () => {
		authProfilesPromise ??= import("./auth-profiles-CRytMogm.js");
