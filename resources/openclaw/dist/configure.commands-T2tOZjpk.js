...
import { c as isSecretRef, l as isValidEnvSecretRefId } from "./types.secrets-_0JOMGE5.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint } from "./auth-install-policy-O7nc7i9I.js";
import { r as isNonFatalSystemdInstallProbeError } from "./systemd-BXTM6gEb.js";
...
import { s as resolvePluginContributionOwners } from "./plugin-registry-ChcJPHWl.js";
...
import { t as ConfigMutationConflictError } from "./config-C9RxTsn1.js";
...
import { t as createClackPrompter } from "./clack-prompter-fc9v8HJv.js";
import { r as logConfigUpdated } from "./logging-Cr7I5jF_.js";
import { t as commitConfigWithPendingPluginInstalls } from "./plugins-install-record-commit--Zbbdxlm.js";
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-DXyUiHQ-.js";
import { a as outro, c as text, i as intro, n as CONFIGURE_WIZARD_SECTIONS, o as parseConfigureWizardSections, r as confirm, s as select, t as CONFIGURE_SECTION_OPTIONS } from "./configure.shared-tjL8qheG.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-BelGczGT.js";
import { n as applyAuthChoice } from "./auth-choice-Bb5NCx3i.js";
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-BD8UmMfD.js";
import { i as setupChannels } from "./onboard-channels-CR34I3LC.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-BOdMUWYa.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-BYD8LXaq.js";
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-CBhmbJoM.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-C68ZMSoi.js";
import { t as applyPrimaryModel } from "./provider-model-primary-CjrsffUO.js";
import { t as promptCustomApiConfig } from "./onboard-custom-CWwis0KM.js";
import { a as validateIPv4AddressInput, i as maybeAddTailnetOriginToControlUiAllowedOrigins, n as TAILSCALE_EXPOSURE_OPTIONS, r as TAILSCALE_MISSING_BIN_NOTE_LINES, t as TAILSCALE_DOCS_LINES } from "./gateway-config-prompts.shared-Bx9Y06Mk.js";
...
import { t as setupSkills } from "./onboard-skills-BoUgPd-Y.js";
...
const setupPluginConfigModuleLoader = createLazyImportLoader(() => import("./setup.plugin-config-BjGF-JLz.js"));
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-edGnsU7Z.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-BaCIbWUO.js");
