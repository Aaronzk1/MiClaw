...
import { i as resolveProviderRequestPolicy } from "./provider-attribution-GEHCfopl.js";
...
import { a as patchCodexNativeWebSearchPayload, o as resolveCodexNativeSearchActivation } from "./codex-native-web-search-core-B2S2BXKl.js";
import { C as emitModelTransportDebug, S as stripCompletionMessagesToRoleContent, b as resolveOpenAIReasoningEffortForModel, i as createOpenAIResponsesTransportStreamFn, v as applyOpenAIResponsesPayloadPolicy, x as flattenCompletionMessagesToStringContent, y as resolveOpenAIResponsesPayloadPolicy } from "./openai-transport-stream-BVQx4NgZ.js";
import { t as log$1 } from "./logger-B8odRltZ.js";
import { i as streamWithPayloadPatch } from "./moonshot-thinking-RT-IFIsx.js";
import { r as resolveAnthropicEphemeralCacheControl, t as applyAnthropicEphemeralCacheControlMarkers } from "./anthropic-payload-policy-ZFzBdZJv.js";
...
function createOpenAIResponsesContextManagementWrapper(baseStreamFn, extraParams) {
	...
	return (model, context, options) => {
		...
		const replayResponsesItemIds = policy.explicitStore === void 0 ? options?.replayResponsesItemIds : policy.explicitStore;
