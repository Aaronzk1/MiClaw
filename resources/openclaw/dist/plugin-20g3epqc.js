...
import { h as MarkdownConfigSchema } from "./zod-schema.core-1wQTyhOa.js";
...
import { h as runStoppablePassiveMonitor, n as buildPassiveProbedChannelStatusSummary } from "./extension-shared-B8fkO3TV.js";
import "./channel-config-primitives-Bk3iiMir.js";
import { i as createPairingPrefixStripper, r as createLoggedPairingApprovalNotifier } from "./channel-pairing-Bk6_JhTm.js";
		...
		gateway: {
			startAccount: async (ctx) => {
				...
				await runStoppablePassiveMonitor({
					...
					start: async () => {
						const { monitorTwitchProvider } = await import("./monitor-C7n-YX2G.js");
