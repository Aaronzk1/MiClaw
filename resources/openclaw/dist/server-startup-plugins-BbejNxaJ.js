...
import { r as collectUnregisteredConfiguredMemoryEmbeddingProviders } from "./gateway-startup-plugin-ids-3X_G47Qt.js";
...
import { j as listRegisteredEmbeddingProviders } from "./registry-CYsBNH12.js";
import { I as createEmptyPluginRegistry, S as setActivePluginRegistry, o as getActivePluginRegistry } from "./runtime-B2ROiq5l.js";
import "./channel-plugin-ids-yxLDmEfb.js";
import { n as loadPluginLookUpTable } from "./plugin-lookup-table-BiEbugjx.js";
import { l as initSubagentRegistry } from "./subagent-registry-BeWX0MLH.js";
import { t as mergeActivationSectionsIntoRuntimeConfig } from "./plugin-activation-runtime-config-ChqOWNk0.js";
import { n as listGatewayMethods } from "./server-methods-list-BcMuybf7.js";
...
async function prepareGatewayPluginBootstrap(params) {
	...
	if (!params.minimalTestGateway || startupMaintenanceConfig.channels !== void 0) {
		const { runChannelPluginStartupMaintenance } = await import("./lifecycle-startup-N35VfyFt.js");
		...
		if (!params.minimalTestGateway) {
			const { runStartupSessionMigration } = await import("./server-startup-session-migration-2nZaRbhW.js");
...
async function loadGatewayStartupPluginRuntime(params) {
	const { loadGatewayStartupPlugins } = await import("./server-plugin-bootstrap-C1t0ZYOK.js");
