...
import { n as applySkillEnvOverridesFromSnapshot } from "./env-overrides-DDFJJj9B.js";
...
import { d as sanitizeToolResult, u as sanitizeToolArgs } from "./embedded-agent-subscribe.tools-CeNC5LI1.js";
...
import { a as createCliJsonlStreamingParser, i as shouldUseClaudeLiveSession, o as extractCliErrorMessage, r as runClaudeLiveSessionTurn, s as parseCliOutput } from "./claude-live-session-C2lunJBE.js";
import { c as resolvePromptInput, d as writeCliSystemPromptFile, f as buildCliSupervisorScopeKey, i as enqueueCliRun, l as resolveSessionIdToSend, m as resolveCliRunTimeoutOverrideMs, o as prepareCliPromptImagePayload, p as resolveCliNoOutputTimeoutMs, r as buildCliArgs, s as resolveCliRunQueueKey, t as buildClaudeOwnerKey, u as resolveSystemPromptUsage } from "./helpers-BLGx1Zfi.js";
			...
			try {
				...
				if (shouldUseClaudeLiveSession(context)) {
					...
					const liveResult = await runClaudeLiveSessionTurn({
						...
						onCommentaryText: context.params.emitCommentaryText ? emitCliCommentaryText : void 0,
						cleanup: async () => {
							try {
