...
const providerIndexCatalogLoader = createLazyImportLoader(() => import("./list.provider-index-catalog-B7QNtQwu.js"));
...
async function planAllModelListSources(params) {
	...
	const manifestCatalog = await import("./list.manifest-catalog-CMbHn9gg.js");
	...
	const providerCatalog = await import("./list.provider-catalog-DExsmK6_.js");
