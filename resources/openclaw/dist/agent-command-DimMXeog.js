...
import { a as resolveAgentDir, c as resolveDefaultAgentId, n as listAgentIds, o as resolveAgentWorkspaceDir, r as resolveAgentConfig } from "./agent-scope-config-CgCYpZfK.js";
import { d as readConfigFileSnapshotForWrite, i as getRuntimeConfig } from "./io-Gi7-pyU-.js";
...
import { g as normalizeVerboseLevel, n as isThinkingLevelSupported, o as resolveSupportedThinkingLevel, p as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-OG7pb4lf.js";
...
import { s as loadManifestMetadataSnapshot } from "./manifest-contract-eligibility-DEeoLRlM.js";
import { i as emitAgentEvent, t as clearAgentRunContext, u as registerAgentRunContext } from "./agent-events-C1B8VhOg.js";
...
import { o as resolveMessageChannel, t as isDeliverableMessageChannel } from "./message-channel-normalize-BLLf0ubu.js";
...
import { n as isStoredCredentialCompatibleWithAuthProvider } from "./order-CdBVYd7c.js";
import { g as resolveConfiguredModelRef, i as buildModelAliasIndex, r as buildConfiguredModelCatalog, y as resolveModelRefFromString } from "./model-selection-shared-b32cUYts.js";
...
import { t as loadManifestModelCatalog } from "./model-catalog-0-HKr2yW.js";
...
import { K as createTrajectoryRuntimeRecorder, t as resolveAvailableAgentHarnessPolicy } from "./selection-BP0T9R9I.js";
import { s as normalizeSpawnedRunMetadata } from "./subagent-spawn-plan-DY8rBX1m.js";
...
import { f as LiveSessionModelSwitchError, o as runWithModelFallback } from "./model-fallback-BvQwEryh.js";
import { n as resolveSession } from "./session-CKACMDmr.js";
import { t as getAgentRuntimeCommandSecretTargetIds } from "./command-secret-targets-DY8QOUoE.js";
...
import "./live-model-switch-t4Dv5htR.js";
import { t as classifyEmbeddedAgentRunResultForModelFallback } from "./result-fallback-classifier-vfh2jCL6.js";
import { r as resolveInlineAgentImageAttachments } from "./agent-turn-attachments-BVNZMNvw.js";
import { t as resolveFastModeState } from "./fast-mode-CmAyxTkZ.js";
import { t as clearSessionAuthProfileOverride } from "./session-override-Bjia8kVD.js";
import { t as NodeRegistry } from "./node-registry-DzMBNLUj.js";
import { r as resolveAgentOutboundTarget, t as resolveAgentDeliveryPlan } from "./agent-delivery-DgS5lONr.js";
import { n as applyVerboseOverride } from "./level-overrides-D6cD7r8A.js";
import { a as resolveInternalEventTranscriptBody, i as resolveAcpPromptBody, n as persistSessionEntry$1, r as prependInternalEventContext, t as resolveAgentRunContext } from "./run-context-BebY4598.js";
...
const acpRuntimeErrorsRuntimeLoader = createLazyImportLoader(() => import("./errors-C6KFZ2tP.js"));
...
const cliCompactionRuntimeLoader = createLazyImportLoader(() => import("./cli-compaction-DBT3u8Yy.js"));
const transcriptResolveRuntimeLoader = createLazyImportLoader(() => import("./transcript-resolve.runtime.js"));
const cliDepsRuntimeLoader = createLazyImportLoader(() => import("./deps-CU5NS34E.js"));
const execDefaultsRuntimeLoader = createLazyImportLoader(() => import("./exec-defaults-BdOVWCEe.js"));
const skillsRuntimeLoader = createLazyImportLoader(async () => {
	const [remote, sessionSnapshot] = await Promise.all([import("./remote-BmS7hfeI.js"), import("./session-snapshot-CCwADDJ5.js")]);
	return {
...
async function agentCommandInternal(opts, runtime = defaultRuntime, deps) {
	...
	try {
		...
		if (!isRawModelRun && acpResolution?.kind === "ready" && sessionKey) {
			...
			registerAgentRunContext(runId, suppressVisibleSessionEffects ? { isControlUiVisible: false } : {
				sessionKey,
				sessionId
			});
