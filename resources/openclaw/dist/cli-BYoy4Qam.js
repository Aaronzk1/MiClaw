...
import { n as updateMatrixAccountConfig, t as resolveMatrixConfigPath } from "./config-update-IQZLcp6g.js";
import { n as matrixSetupAdapter } from "./setup-core-CJKT0lOC.js";
import { t as withResolvedActionClient } from "./client-BSvW01Nw.js";
import { r as resolveMatrixAuthContext } from "./config-BKydsp1f.js";
...
import { n as updateMatrixOwnProfile, t as applyMatrixProfileUpdate } from "./profile-update-DzRG3RN-.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-BgmngvRr.js";
...
function loadMatrixActionClientModule() {
	matrixActionClientModulePromise ??= import("./client-Cr50xR0h.js");
...
async function addMatrixAccount(params) {
	...
	if (accountConfig.encryption === true) {
		const { maybeBootstrapNewEncryptedMatrixAccount } = await import("./setup-bootstrap-CnULAw1Q.js");
