...
import { l as isValidEnvSecretRefId, m as resolveSecretInputRef, o as coerceSecretRef } from "./types.secrets-_0JOMGE5.js";
...
import { a as isValidFileSecretRefId, c as secretRefKey, i as isValidExecSecretRefId, l as validateExecSecretRefId, o as isValidSecretProviderAlias, r as formatExecSecretRefIdValidationMessage } from "./ref-contract-BAa3qHwr.js";
import { a as resolveSecretRefValue, l as resolveSecretProviderIntegrationConfig, s as isPluginIntegrationSecretProviderConfig } from "./resolve-DPFnV1p0.js";
...
import { n as discoverConfigSecretTargets, s as resolveConfigSecretTargetByPath } from "./target-registry-0k0oK6Ia.js";
import { n as info, o as success, t as danger } from "./globals-GTrXU4s9.js";
import { S as collectUnsupportedSecretRefPolicyIssues, T as validateConfigObjectRawWithPlugins, W as AUTO_MANAGED_CONFIG_META_PATHS, u as readConfigFileSnapshot } from "./io-Gi7-pyU-.js";
import { T as SecretProviderSchema } from "./zod-schema.core-1wQTyhOa.js";
import { n as formatConfigIssueLines, o as normalizeConfigIssues } from "./issue-format-CwCoGNbt.js";
...
import { n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-BjT8eJxD.js";
import { n as setCommandJsonMode } from "./json-mode-CJba5jsj.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/patch/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-yakXLLdq.js");
