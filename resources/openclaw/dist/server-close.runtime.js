...
import { r as abortTrackedChatRunById } from "./chat-abort-Cu_ehtms.js";
...
import { r as drainActiveSessionsForShutdown } from "./session-reset-service-DG5dw0Ix.js";
...
async function disposeAllBundleLspRuntimesOnDemand() {
	const { disposeAllBundleLspRuntimes } = await import("./agent-bundle-lsp-runtime-D46jskgq.js");
	await disposeAllBundleLspRuntimes();
}
async function stopGmailWatcherOnDemand() {
	const { stopGmailWatcher } = await import("./gmail-watcher-B2RJfulT.js");
