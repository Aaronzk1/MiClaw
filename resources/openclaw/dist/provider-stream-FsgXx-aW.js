...
import { A as resolveProviderStreamFn } from "./provider-runtime-CJtW0nDR.js";
...
import { i as getModelProviderRequestTransport } from "./provider-request-config-0Zg8QIAI.js";
...
import { c as registerApiProvider, o as getApiProvider } from "./stream-4H1GSjKe.js";
...
import { i as resolveAnthropicPayloadPolicy, n as applyAnthropicPayloadPolicyToParams } from "./anthropic-payload-policy-ZFzBdZJv.js";
...
function buildAnthropicParams(model, context, isOAuthToken, options) {
	...
	if (options?.toolChoice) params.tool_choice = normalizeAnthropicToolChoice(model, options.toolChoice);
