...
import { i as redactSecrets } from "./redact-DduLliKq.js";
...
import { D as runWithDiagnosticTraceContext, S as getActiveDiagnosticTraceContext, _ as createChildDiagnosticTraceContext, a as emitTrustedDiagnosticEvent, b as formatDiagnosticTraceparent, o as emitTrustedDiagnosticEventWithPrivateData, t as areDiagnosticsEnabledForProcess, v as createDiagnosticTraceContext, x as freezeDiagnosticTraceContext } from "./diagnostic-events-Chmz2PSy.js";
...
import { a as resolveAgentDir, r as resolveAgentConfig } from "./agent-scope-config-CgCYpZfK.js";
...
import { a as listRegisteredAgentHarnesses, r as getRegisteredAgentHarness } from "./registry-DJ-L47Jb.js";
import { N as listRegisteredPluginAgentPromptGuidance } from "./command-registration-Bp1_oQY0.js";
import { b as createCodeModeNamespaceRuntime, x as describeCodeModeNamespacesForPrompt, y as createCodeModeApiVirtualFiles } from "./registry-CYsBNH12.js";
import { f as setReplyPayloadMetadata } from "./reply-payload-CZJ2cgZc.js";
import { l as fireAndForgetBoundedHook, s as resolveBlockMessage, t as getGlobalHookRunner } from "./hook-runner-global-BnyQREr6.js";
import { d as listImportedRuntimePluginIds, o as getActivePluginRegistry } from "./runtime-B2ROiq5l.js";
import { s as resolveContextEngineOwnerPluginId } from "./registry-Dca-zXEr.js";
import { a as emitAgentItemEvent, i as emitAgentEvent, n as emitAgentApprovalEvent, o as emitAgentPatchSummaryEvent, r as emitAgentCommandOutputEvent } from "./agent-events-C1B8VhOg.js";
...
import { c as runQuotaSuspensionMaintenance, f as updateSessionStoreEntry } from "./store-Qsgtu-0y.js";
...
import { c as bindOwnedSessionTranscriptWrites, l as withOwnedSessionTranscriptWrites } from "./transcript-Cw-EfeYD.js";
...
import { c as resolveSessionLockMaxHoldFromTimeout, d as resolveSessionWriteLockOptions, i as acquireSessionWriteLock } from "./session-write-lock-D4phDYfI.js";
...
import { d as resolveProviderRuntimePluginHandle } from "./provider-hook-runtime-yK6Rr2x1.js";
import { G as transformProviderSystemPrompt, M as resolveProviderSystemPromptContribution, N as resolveProviderTextTransforms } from "./provider-runtime-CJtW0nDR.js";
import { n as parseBooleanValue } from "./boolean-By0bZpFH.js";
import { t as describeProviderRequestRoutingSummary } from "./provider-attribution-GEHCfopl.js";
import { t as sanitizeForConsole } from "./console-sanitize-Bf1BpkZq.js";
import { o as normalizeProviderId$1 } from "./model-selection-normalize-roKDxQ9_.js";
...
import { a as sanitizeToolCallIdsForCloudCodeAssist, r as extractToolResultIds, t as extractToolCallsFromAssistant } from "./tool-call-id-DOLZ5Kkz.js";
import { a as stripToolResultDetails, i as sanitizeToolUseResultPairing } from "./session-transcript-repair-B17NYGhL.js";
import { i as streamSimple } from "./stream-4H1GSjKe.js";
import { o as createAgentSession } from "./sessions-BTpdzjUa.js";
import { t as SessionManager } from "./session-manager-_IGt1AS6.js";
import { t as detectRuntimeShell } from "./shell-utils-DKmnHE0C.js";
import { f as resolveModelAuthMode } from "./model-auth-DVfmdW0b.js";
import { h as isWorkspaceBootstrapPending, n as DEFAULT_BOOTSTRAP_FILENAME } from "./workspace-B0bmoo98.js";
import { r as stripInboundMetadata } from "./strip-inbound-meta-BHmOsIBM.js";
import { U as isTerminalTaskStatus } from "./task-registry-FH-Ti23C.js";
import { C as promoteStandalonePlainTextToolCallMessage, S as extractStandalonePlainTextToolCallText, T as scrubOverCapPlainTextToolCallMessage, w as normalizePlainTextToolCallStreamEvents } from "./provider-stream-shared-BIV_zuwB.js";
...
import { C as parseExecApprovalResultText } from "./sanitize-user-facing-text-DDpUeAo_.js";
import { t as resolveAgentTimeoutMs } from "./timeout-Drw0_zOv.js";
import { o as markDiagnosticRunProgress } from "./diagnostic-run-activity-BqeZDY9q.js";
import { b as updateActiveEmbeddedRunSessionFile, d as markActiveEmbeddedRunAbandoned, r as clearActiveEmbeddedRun, w as resolveEmbeddedSessionFileKey, x as updateActiveEmbeddedRunSnapshot, y as setActiveEmbeddedRun } from "./runs-B4dP_Q30.js";
...
import { n as extractModelCompat, o as resolveToolCallArgumentsEncoding } from "./provider-model-compat-DhKi-Qv5.js";
import { d as isCloudCodeAssistFormatError, n as classifyFailoverReason, s as formatUserFacingAssistantErrorText } from "./errors-B5Da2wE-.js";
import { f as couldNormalizeToolNamePrefixToAllowedTool, h as normalizeToolName, m as normalizeToolList, p as expandToolGroups } from "./tool-policy-CpBMaMTY.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-DNNoBvYA.js";
import { c as isTimeoutError } from "./failover-error-DAwMDmz6.js";
...
import { r as isCliRuntimeAliasForProvider } from "./model-runtime-aliases-6XX4uD6a.js";
...
import { t as filterHeartbeatTranscriptArtifacts } from "./heartbeat-filter-D4dPmFvN.js";
...
import { T as isEmbeddedMode, f as isStrictAgenticSupportedProviderModel, p as stripProviderPrefix } from "./openclaw-tools-C0nKaVVY.js";
import { r as resolveHeartbeatSummaryForAgent } from "./heartbeat-summary-B73O--Iv.js";
import { t as getMachineDisplayName } from "./machine-name-CBTz5R12.js";
import { f as sanitizeTransportPayloadText, h as supportsModelTools, m as buildGuardedModelFetch, u as mergeTransportHeaders } from "./openai-transport-stream-BVQx4NgZ.js";
import { t as log$2 } from "./logger-B8odRltZ.js";
import { u as createCodexNativeWebSearchWrapper } from "./proxy-2a5P4QqJ.js";
...
import { a as buildCodeSpanIndex, o as createInlineCodeState } from "./openai-completions-DObeyZ3K.js";
...
import { u as resolveSkillsPromptForRun } from "./workspace-_gXfieOh.js";
import { n as resolveSandboxSkillRuntimeInputs, r as resolveEmbeddedRunSkillEntries, t as mapSandboxSkillEntriesForPrompt } from "./sandbox-skills-Bn2SzSN6.js";
import { n as applySkillEnvOverridesFromSnapshot, t as applySkillEnvOverrides } from "./env-overrides-DDFJJj9B.js";
...
import { A as resolveChannelMessageToolHints, M as resolveChannelReactionGuidance, S as markCodeModeControlTool, k as listChannelSupportedActions, v as CODE_MODE_EXEC_TOOL_NAME, x as isCodeModeControlTool, y as CODE_MODE_WAIT_TOOL_NAME } from "./agent-tools.before-tool-call-BkVrW03y.js";
...
import { a as toClientToolDefinitions, n as createClientToolNameConflictError, r as findClientToolNameConflicts, t as splitSdkTools } from "./tool-split-jrKfShnK.js";
import { _ as filterLocalModelLeanTools, a as TOOL_SEARCH_CODE_MODE_TOOL_NAME, c as addClientToolsToToolCatalog, d as applyToolSearchCatalog, f as clearToolSearchCatalog, g as applyLocalModelLeanToolSearchDefaults, h as resolveToolSearchConfig, i as TOOL_DESCRIBE_RAW_TOOL_NAME, l as addClientToolsToToolSearchCatalog, m as projectToolSearchTargetTranscriptMessages, n as resolveProcessToolScopeKey, o as TOOL_SEARCH_RAW_TOOL_NAME, p as createToolSearchCatalogRef, r as TOOL_CALL_RAW_TOOL_NAME, s as ToolSearchRuntime, t as createOpenClawCodingTools, u as applyToolCatalogCompaction, v as isLocalModelLeanEnabled, y as resolveLocalModelLeanPreserveToolNames } from "./agent-tools-uBjiioJ8.js";
import { o as REQUIRED_PARAM_GROUPS } from "./nodes-utils-CTBPI5uk.js";
...
import { c as hasCommittedMessagingToolDeliveryEvidence, f as hasAcceptedSessionSpawn, l as hasMessagingToolDeliveryEvidence, p as normalizeAcceptedSessionSpawnResult, y as mediaUrlsFromGeneratedAttachments } from "./subagent-announce-delivery-B2BgoPnM.js";
import { t as sanitizeForPromptLiteral } from "./sanitize-for-prompt-ByaJGDhT.js";
import { b as resolveBootstrapTotalMaxChars, d as normalizeOpenAIResponsesToolCallIds, l as downgradeOpenAIFunctionCallReasoningPairs, n as validateAnthropicTurns, o as isMessagingToolDuplicateNormalized, r as validateGeminiTurns, s as normalizeTextForComparison, u as downgradeOpenAIReasoningBlocks, v as resolveBootstrapMaxChars, y as resolveBootstrapPromptTruncationWarningMode } from "./embedded-agent-helpers-7sfpu1OT.js";
import { P as formatToolAggregate } from "./streaming-_TVeMLGC.js";
import { d as parseReplyDirectives } from "./payloads-B4DTFTLz.js";
import { d as shouldSuppressRawErrorConsoleSuffix, l as buildApiErrorObservationFields, p as MissingAgentHarnessError, u as buildTextObservationFields } from "./model-fallback-BvQwEryh.js";
import { a as extractThinkingFromTaggedStream, c as inferToolMetaFromArgs, d as sanitizeAssistantVisibleStreamText, i as extractAssistantVisibleText, l as isAssistantMessage, n as extractAssistantText, o as extractThinkingFromTaggedText, r as extractAssistantThinking, t as THINKING_TAG_SCAN_RE, u as promoteThinkingTagsToBlocks } from "./embedded-agent-utils-CUYamrTB.js";
...
import { t as registerProviderStreamForModel } from "./provider-stream-FsgXx-aW.js";
import { b as prependAgentSteeringPrompt, g as releasePendingAgentSteeringItems, t as ackPendingAgentSteeringItems, u as leasePendingAgentSteeringItems } from "./subagent-registry-BeWX0MLH.js";
...
import { i as makeBootstrapWarn, n as buildBootstrapContextForFiles, o as resolveBootstrapFilesForRun, r as hasCompletedBootstrapTurn, s as resolveContextInjectionMode, t as FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE } from "./bootstrap-files-DiRvjZAg.js";
...
import { n as isMessagingTool, r as isMessagingToolSendAction, t as isMessageToolSendActionName } from "./embedded-agent-messaging-CprZBAme.js";
import { t as collectTextContentBlocks } from "./content-blocks-DRK0dze4.js";
import { a as extractToolResultMediaArtifact, c as isToolResultError, d as sanitizeToolResult, i as extractToolErrorMessage, l as isToolResultTimedOut, n as extractMessagingToolSend, o as extractToolResultText, r as extractToolErrorCode, s as filterToolResultMediaUrls, t as buildToolLifecycleErrorResult, u as sanitizeToolArgs } from "./embedded-agent-subscribe.tools-CeNC5LI1.js";
...
import { n as runAgentEndSideEffects } from "./agent-end-side-effects-Ba50U1Ua.js";
import { i as runAgentHarnessBeforeAgentFinalizeHook } from "./lifecycle-hook-helpers-BiRlZKs7.js";
import { i as resolveAgentPromptSurfaceForSessionKey, n as appendModelIdentitySystemPrompt, r as buildModelIdentityPromptLine } from "./system-prompt-config-CVau6v04.js";
import { n as filterRuntimeCompatibleTools } from "./tool-schema-projection-DRzFBr6V.js";
import { n as normalizeAgentRuntimeTools, t as logAgentRuntimeToolDiagnostics } from "./tools-C5Dgo3sN.js";
import { a as resolveLiveToolResultMaxChars, d as formatContextLimitTruncationNotice, l as truncateOversizedToolResultsInSessionManager, s as truncateOversizedToolResultsInMessages } from "./tool-result-truncation-BiAgZIVd.js";
...
import { c as resolveCompactionTimeoutMs, d as shouldAllowProviderOwnedThinkingReplay, u as resolveTranscriptPolicy } from "./tool-result-middleware-B3Hdp_cV.js";
import { a as resolvePreparedExtraParams, i as resolveExtraParams, n as resolveAgentTransportOverride, o as isGooglePromptCacheEligible, r as resolveExplicitSettingsTransport, s as resolveCacheRetention, t as applyExtraParamsToAgent } from "./extra-params-CQOwTzpP.js";
...
import { a as finalizeHarnessContextEngineTurn, c as runContextEngineMaintenance, n as bootstrapHarnessContextEngine, t as assembleHarnessContextEngine } from "./context-engine-lifecycle-CVy46YJP.js";
import { t as applyFinalEffectiveToolPolicy } from "./effective-tool-policy-B_2ZMFOZ.js";
import { r as resolveEmbeddedSandboxInfoExecPolicy, t as buildEmbeddedSandboxInfo } from "./sandbox-info-Dn4KL4Mg.js";
import { a as estimateLlmBoundaryTokenPressure, c as shouldPreemptivelyCompactBeforePrompt, i as buildPrePromptContextBudgetStatus, n as runAgentCleanupStep, r as PREEMPTIVE_OVERFLOW_ERROR_TEXT, s as formatPrePromptPrecheckLog, t as buildEmbeddedAttemptToolRunContext } from "./attempt.tool-run-context-CJUiBo7z.js";
import { a as shouldCreateBundleMcpRuntimeForAttempt, i as shouldCreateBundleLspRuntimeForAttempt, n as mergeForcedEmbeddedAttemptToolsAllow, r as resolveEmbeddedAttemptToolConstructionPlan, t as applyEmbeddedAttemptToolsAllow } from "./attempt-tool-construction-plan-C32M6pQQ.js";
import { i as listTasksForOwnerOrRequesterSessionKeyForStatus, t as findTaskByRunIdForStatus } from "./task-status-access-ihiHv2MJ.js";
...
import "./tool-loop-detection-B6iub_ig.js";
import { i as shouldPersistCompletedBootstrapTurn, n as composeSystemPromptWithHookContext, r as resolveAttemptSpawnWorkspaceDir, t as appendAttemptCacheTtlIfNeeded } from "./attempt.thread-helpers-UNL5VFeq.js";
import { n as extractBalancedJsonPrefix } from "./balanced-json-Ccq_0iyB.js";
import { t as detectAndLoadPromptImages } from "./images-B8VItvqy.js";
import { o as resolveRuntimeContextPromptParts, r as buildRuntimeContextCustomMessage, t as buildCurrentInboundPrompt } from "./runtime-context-prompt-BJmPR0_F.js";
...
* telemetry.
*/
const execApprovalReplyModuleLoader = createLazyImportLoader(() => import("./exec-approval-reply-CsFnt-iA.js"));
const hookRunnerGlobalModuleLoader = createLazyImportLoader(() => import("./plugins/hook-runner-global.js"));
const beforeToolCallModuleLoader = createLazyImportLoader(() => import("./agent-tools.before-tool-call-CcvatdRI.js"));
...
function handleAgentEnd(ctx, evt) {
	...
	const emitLifecycleTerminal = () => {
		const terminalStopReason = ctx.state.terminalStopReason ?? (!isError && isAssistantMessage(lastAssistant) ? lastAssistant.stopReason : void 0);
...
function subscribeEmbeddedAgentSession(params) {
	...
	const state = {
		...
		reasoningMode,
		includeReasoning: (reasoningMode === "on" || reasoningMode === "stream") && canShowReasoning,
...
async function runEmbeddedAttempt(params) {
	...
	try {
		...
		const toolSearchControlsEnabledForRun = toolsEnabled && params.disableTools !== true && !isRawModelRun && params.toolsAllow?.length !== 0 && !codeModeControlsEnabledForRun && resolveToolSearchConfig(toolSearchRuntimeConfig).enabled;
