import { _ as PluginDiagnostic, a as PluginDependencyStatus, d as PluginKind, g as PluginConfigUiHint, h as PluginBundleFormat, s as PluginManifestContracts, v as PluginFormat } from "./manifest-registry-C_uwfra_.js";
...
import { i as PluginCompatCode } from "./installed-plugin-index-types-b33UJBZg.js";
import { $ as OpenClawPluginService, $n as PluginRuntime, D as OpenClawPluginCliRegistrar, Ei as PluginTrustedToolPolicyRegistration, F as OpenClawPluginHttpRouteHandler, Fi as CliBackendPlugin, Gn as RealtimeTranscriptionProviderPlugin, H as OpenClawPluginNodeHostCommand, Hs as WebFetchProviderPlugin, I as OpenClawPluginHttpRouteMatch, Jn as TranscriptSourceProvider, Js as WebSearchProviderPlugin, Kn as RealtimeVoiceProviderPlugin, M as OpenClawPluginGatewayRuntimeScopeSurface, N as OpenClawPluginHostedMediaResolver, O as OpenClawPluginCommandDefinition, Oi as CodexAppServerExtensionFactory, P as OpenClawPluginHttpRouteAuth, R as OpenClawPluginHttpRouteUpgradeHandler, St as PluginTextTransformRegistration, T as OpenClawPluginCliCommandDescriptor, Ta as AgentHarness, Ti as PluginToolMetadataRegistration, Ts as OpenClawPluginToolFactory, W as OpenClawPluginNodeInvokePolicy, Wi as AgentToolResultMiddleware, Xi as AgentToolResultMiddlewareRuntime, Xn as UnifiedModelCatalogProviderPlugin, Y as OpenClawPluginReloadRegistration, Z as OpenClawPluginSecurityAuditCollector, Zn as VideoGenerationProviderPlugin, a as ImageGenerationProviderPlugin, b as OpenClawGatewayDiscoveryService, ci as PluginAgentEventSubscriptionRegistration, cn as ProviderPlugin, fi as PluginRuntimeLifecycleRegistration, h as MigrationProviderPlugin, ht as PluginLogger, li as PluginControlUiDescriptor, mi as PluginSessionActionRegistration, o as MediaUnderstandingProviderPlugin, qn as SpeechProviderPlugin, v as MusicGenerationProviderPlugin, xi as PluginSessionSchedulerJobRegistration, yi as PluginSessionExtensionRegistration } from "./types-C0dQmare.js";
import { _ as GatewayMethodDescriptor, i as GatewayRequestHandlers, y as CronServiceContract } from "./types-DF3JY91V.js";
...
import { nt as PluginHookRegistration$1 } from "./hook-types-Ciec6sPw.js";
import { t as ChannelPlugin } from "./types.plugin-BIHyhl5u.js";
import { a as PluginConversationBindingResolvedEvent } from "./conversation-binding.types-CYNWpeLp.js";
import { a as PluginActivationSource } from "./config-state-CSNzlzCR.js";
