...
import { b as readStringParam, c as imageResultFromFile, g as readPositiveIntegerParam, l as jsonResult, m as readNonNegativeIntegerParam } from "./common-C4yy9V-D.js";
import { t as callGatewayTool } from "./gateway-Dq9H8-iz.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-CTBPI5uk.js";
...
import { n as startLazyPluginServiceModule } from "./plugin-runtime-Dw_Zc32A.js";
import { o as resolveNodeCommandAllowlist, r as isNodeCommandAllowed } from "./node-command-policy-DYPdfWjH.js";
import { i as safeParseJson, n as respondUnavailableOnNodeInvokeError } from "./nodes.helpers-DeAuiiQp.js";
import { t as describeImageFile } from "./runtime-sq-ErJqP.js";
import "./param-readers-HkqGooLN.js";
import { t as BrowserToolSchema } from "./browser-tool.schema-tt4NcGdm.js";
import { n as withTimeout } from "./sdk-security-runtime-D1sDHmUD.js";
import { L as DEFAULT_AI_SNAPSHOT_MAX_CHARS } from "./cdp.helpers-CTQ-1blZ.js";
import { c as resolveExistingUploadPaths, i as resolveProfile, n as resolveBrowserConfig } from "./config-C2rsUqn7.js";
import "./sdk-setup-tools-Bm-WxrMN.js";
import { _ as browserStop, a as untrackSessionBrowserTab, d as browserOpenTab, f as browserProfiles, g as browserStatus, h as browserStart, i as trackSessionBrowserTab, l as browserDoctor, m as browserSnapshot, o as browserCloseTab, r as touchSessionBrowserTab, u as browserFocusTab, y as browserTabs } from "./session-tab-registry-BG1AGKBy.js";
import { a as applyBrowserProxyPaths, c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as resolveRequestedBrowserProfile, l as browserAct, n as isPersistentBrowserProfileMutation, o as persistBrowserProxyFiles, p as browserScreenshotAction, s as browserConsoleMessages, u as browserArmDialog } from "./core-api-Cugd5en1.js";
import { r as getBrowserProfileCapabilities } from "./target-id-CwSK7UJx.js";
import { n as normalizeBrowserScreenshot } from "./routes-BHi6gQTW.js";
import { t as createBrowserRouteDispatcher } from "./dispatcher-BGpFk5sG.js";
import { n as createBrowserControlContext } from "./plugin-enabled-QojYdRCs.js";
import { t as startBrowserControlServiceFromConfig } from "./control-service-CDT0rmx7.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-BUcgFvOO.js"),
		...
		stop: async () => {
			...
			const { stopBrowserControlService } = await import("./control-service-C-wICWzm.js");
