...
import { a as getPositiveIntFlagValue, c as hasFlag, i as getFlagValue, k as isValueToken, r as getCommandPositionalsWithRootOptions, s as getVerboseFlag } from "./argv-CnfL__6a.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-CxGUjPqA.js";
import { t as createLazyImportLoader } from "./lazy-promise-BONnzNfb.js";
import { n as defaultRuntime } from "./runtime-B4lgFmsS.js";
import { i as cliCommandCatalog, r as matchesCommandPath, t as resolveCliCommandPathPolicy } from "./command-path-policy-B0jd3lsl.js";
import { i as parseStrictPositiveIntOrUndefined } from "./helpers-gBVG4H2O.js";
import { n as ensureCliExecutionBootstrap, r as resolveCliExecutionStartupContext, t as applyCliExecutionStartupPresentation } from "./command-execution-startup-Ckkq0X-v.js";
...
const configCliLoader = createLazyImportLoader(() => import("./config-cli-DC7j84k_.js"));
const agentsListCommandLoader = createLazyImportLoader(() => import("./agents.commands.list-AMLROqTf.js"));
const modelsListCommandLoader = createLazyImportLoader(() => import("./list.list-command-BaGs2hLl.js"));
const modelsStatusCommandLoader = createLazyImportLoader(() => import("./list.status-command-CGLwk2D-.js"));
const tasksJsonCommandLoader = createLazyImportLoader(() => import("./tasks-json-BsF13058.js"));
...
const routedCommandDefinitions = {
	health: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { healthCommand } = await import("./health-B9v-C93Q.js");
	...
	status: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			if (args.json) {
				const { statusJsonCommand } = await import("./status-json-CzgQ8tWi.js");
			...
			const { statusCommand } = await import("./status-BUsX5ajI.js");
	...
	"gateway-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runDaemonStatus } = await import("./status-D6zcQRqq.js");
	...
	sessions: defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { sessionsCommand } = await import("./sessions-DMIMtB8M.js");
	...
	"channels-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsListCommand } = await import("./list-CyAfVw69.js");
	...
	"channels-status": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { channelsStatusCommand } = await import("./status-C2M02NJv.js");
	...
	"plugins-list": defineRoutedCommand({
		...
		runParsedArgs: async (args) => {
			const { runPluginsListCommand } = await import("./plugins-list-command-DTntEbuI.js");
