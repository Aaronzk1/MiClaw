...
import { t as registerShortTermPromotionDreaming } from "../../dreaming-BTtew_Nb.js";
import { t as resolveMemoryCoreNowMs } from "../../time-DhPCijtC.js";
import { r as registerBuiltInMemoryEmbeddingProviders } from "../../provider-adapters-B6qmIXxN.js";
...
function loadMemoryToolsModule() {
	memoryToolsModulePromise ??= import("../../tools-C_JRyDeX.js");
	return memoryToolsModulePromise;
}
function loadRuntimeProviderModule() {
	runtimeProviderModulePromise ??= import("../../runtime-provider-o9yLX_e5.js");
	...
	register(api) {
		...
		api.registerMemoryCapability({
			...
			publicArtifacts: { async listArtifacts(params) {
				const { listMemoryCorePublicArtifacts } = await import("../../public-artifacts-BTact06i.js");
		...
		api.registerCommand({
			...
			acceptsArgs: true,
			handler: async (ctx) => {
				const { handleDreamingCommand } = await import("../../dreaming-command-B4Q_7_lY.js");
