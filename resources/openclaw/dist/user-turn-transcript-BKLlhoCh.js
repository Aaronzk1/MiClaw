...
import { O as resolveProviderReasoningOutputModeWithPlugin } from "./provider-runtime-CJtW0nDR.js";
...
async function persistUserTurnTranscript(params) {
	...
	if (!message) return;
	const { resolveSessionTranscriptFile } = await import("./transcript-C8jH4p48.js");
...
function createUserTurnTranscriptRecorder(params) {
	...
	const handlePersistenceError = (error) => {
		...
		import("./globals-_B32ri4-.js").then(({ logVerbose }) => {
