...
import { c as checkBrowserOrigin } from "./auth-DXSWhsnk.js";
...
import { m as runBeforeToolCallHook } from "./agent-tools.before-tool-call-BkVrW03y.js";
...
function normalizeMcpCurrentInboundAudio(value) {
	const trimmed = normalizeOptionalString(value);
...
function resolveMcpRequestContext(req, cfg, auth) {
	return {
		...
		currentInboundAudio: normalizeMcpCurrentInboundAudio(getHeader(req, "x-openclaw-current-inbound-audio")),
