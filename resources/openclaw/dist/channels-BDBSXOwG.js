...
import { a as getBundledChannelSetupPlugin } from "./bundled-DcYUmgzC.js";
...
import { a as normalizeChannelId$1, n as getLoadedChannelPlugin, t as getChannelPlugin } from "./registry-MkxNn1Ue.js";
import "./plugins-t2ejWcVy.js";
import "./message-channel-BiOeMu0l.js";
import "./logging-CvNAh8ZC.js";
import { t as listManifestChannelContributionIds } from "./manifest-contribution-ids-SDxxvWhJ.js";
import { l as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-BhmC0Myk.js";
...
import { o as getChannelsCommandSecretTargetIds } from "./command-secret-targets-DY8QOUoE.js";
...
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-BCjPdSkx.js";
import { n as resolveLogFile } from "./log-tail-472n_nQU.js";
...
import { t as applyAgentBindings } from "./agents.bindings-Ih6TOgX-.js";
import { t as requireValidConfigFileSnapshot } from "./config-validation-Bz2qAeof.js";
import { c as shouldUseWizard, o as formatChannelAccountLabel, s as requireValidConfig } from "./shared-vtv0TMAo.js";
import { t as channelsListCommand } from "./list-C42d9gRr.js";
import { n as formatGatewayChannelsStatusLines, t as channelsStatusCommand } from "./status-BIpVw_QG.js";
...
const channelSetupPluginInstallLoader = createLazyImportLoader(() => import("./plugin-install-2p4B0Ns4.js"));
const onboardChannelsLoader = createLazyImportLoader(() => import("./onboard-channels-BQbbJqOI.js"));
...
async function resolveCatalogChannelEntry(raw, cfg) {
	...
	if (!trimmed) return;
	return (cfg ? await import("./trusted-catalog-BMRfMlSe.js").then(({ listTrustedChannelPluginCatalogEntries }) => listTrustedChannelPluginCatalogEntries({
		cfg,
		workspaceDir: resolveAgentWorkspaceDir(cfg, resolveDefaultAgentId(cfg))
	})) : await import("./catalog-BmJHJqAv.js").then(({ listRawChannelPluginCatalogEntries }) => listRawChannelPluginCatalogEntries({ excludeWorkspace: true }))).find((entry) => {
...
async function channelsAddCommandImpl(opts, runtime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, onboardChannels] = await Promise.all([import("./agents.config-DIfO9Scn.js"), loadOnboardChannels()]);
	...
	if (catalogEntry) {
		...
		const { isCatalogChannelInstalled } = await import("./discovery-C2G3T65s.js");
...
async function channelsRemoveCommand(opts, runtime = defaultRuntime, params) {
	...
	const resolvedPluginState = Boolean(lookupChannel || channel) ? await (async () => {
		const { resolveInstallableChannelPlugin } = await import("./channel-plugin-resolution-B536_dwo.js");
