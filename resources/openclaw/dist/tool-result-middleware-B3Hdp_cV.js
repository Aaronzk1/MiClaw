...
import { u as resolveProviderRuntimePlugin } from "./provider-hook-runtime-yK6Rr2x1.js";
import { o as normalizeProviderId } from "./model-selection-normalize-roKDxQ9_.js";
import "./model-selection-CA_65iXi.js";
import { gt as generateSummary$1 } from "./sessions-BTpdzjUa.js";
import { a as buildStageSplitPlan, i as buildOversizedFallbackPlan, l as sanitizeCompactionMessages, o as buildSummaryChunks, r as buildHistoryPrunePlan, s as computeAdaptiveChunkRatio } from "./compaction-planning-BOByCD2w.js";
import { c as isTimeoutError } from "./failover-error-DAwMDmz6.js";
import { n as retryAsync } from "./retry-BSIArBBz.js";
import { f as isGoogleModelApi } from "./embedded-agent-helpers-7sfpu1OT.js";
import { u as shouldPreserveThinkingBlocks } from "./provider-replay-helpers-BqlBAD9R.js";
...
function createAgentToolResultMiddlewareRunner(ctx, handlers) {
	...
	const resolvedHandlersLoader = createLazyPromiseLoader(async () => {
		const { loadAgentToolResultMiddlewaresForRuntime } = await import("./agent-tool-result-middleware-loader-BUV1bkIq.js");
