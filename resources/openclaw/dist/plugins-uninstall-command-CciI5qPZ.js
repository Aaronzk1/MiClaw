...
import { a as tracePluginLifecyclePhaseAsync, i as tracePluginLifecyclePhase } from "./discovery-BDSfxwT6.js";
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
	...
	const { loadInstalledPluginIndexInstallRecords, removePluginInstallRecordFromRecords, withoutPluginInstallRecords, withPluginInstallRecords } = await import("./installed-plugin-index-records-B7GvzCMT.js");
	const { buildPluginSnapshotReport } = await import("./status-JfK93cyu.js");
	const { applyPluginUninstallDirectoryRemoval, formatUninstallActionLabels, formatUninstallSlotResetPreview, planPluginUninstall, resolveUninstallChannelConfigKeys, UNINSTALL_ACTION_LABELS } = await import("./uninstall-BtlycfRJ.js");
	const { commitPluginInstallRecordsWithConfig } = await import("./plugins-install-record-commit-DL3tqodz.js");
	const { refreshPluginRegistryAfterConfigMutation } = await import("./plugins-registry-refresh-CHxkaZjs.js");
	const { resolvePluginUninstallId } = await import("./plugins-uninstall-selection-BFg38IGL.js");
	const { PromptInputClosedError, promptYesNo } = await import("./prompt-DBwU7FXk.js");
