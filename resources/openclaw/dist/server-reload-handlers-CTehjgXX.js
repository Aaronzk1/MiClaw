...
import { n as loadInstalledPluginIndexInstallRecordsSync, t as loadInstalledPluginIndexInstallRecords } from "./installed-plugin-index-record-reader-CPHayOZI.js";
...
import { f as resolveGatewayRestartDeferralTimeoutMs, m as setGatewaySigusr1RestartPolicy, o as deferGatewayRestartUntilIdle, s as emitGatewayRestart } from "./restart-CiO1ILZU.js";
import { a as resetModelCatalogCache } from "./model-catalog-0-HKr2yW.js";
...
import { d as listActiveEmbeddedRunSessionIds, f as listActiveEmbeddedRunSessionKeys, u as getActiveEmbeddedRunCount } from "./run-state-BYGFyjne.js";
import { u as getTotalQueueSize } from "./command-queue-DGvXlE4p.js";
import { n as getInspectableActiveTaskRestartBlockers } from "./task-registry.maintenance-BO6_16yZ.js";
...
import { n as clearSecretsRuntimeSnapshot, o as getActiveSecretsRuntimeSnapshot } from "./runtime-state-B3MH_XLp.js";
import { r as resetDirectoryCache } from "./target-resolver-CUW6ke8W.js";
...
import { v as resolveHooksConfig } from "./hooks-BuwUpRxl.js";
import { n as markGatewayModelCatalogStaleForReload } from "./server-model-catalog-CcvpyvTp.js";
import { a as diffConfigPaths, n as listPluginInstallTimestampMetadataPaths, r as listPluginInstallWholeRecordPaths, t as buildGatewayReloadPlan } from "./config-reload-plan-D2TNMpG_.js";
...
import { t as buildGatewayCronService } from "./server-cron-BUhoP9it.js";
import { n as applyGatewayLaneConcurrency, t as resolveHookClientIpConfig } from "./hook-client-ip-config-CWB_cWpU.js";
import { t as startGatewayChannelHealthMonitor } from "./server-runtime-startup-services-B_m8NSaC.js";
import { i as startGatewayCronWithLogging } from "./server-runtime-services-Blpvr6WF.js";
...
function startGatewayConfigReloader(opts) {
	...
	const handleWatcherError = (source, err) => {
		...
		if (watcherRecreateRetries >= WATCHER_RECREATE_MAX_RETRIES) {
			...
			opts.log.error(`config hot-reload disabled: watcher failed after ${WATCHER_RECREATE_MAX_RETRIES} re-create attempts: ${String(err)}`);
			return;
		}
...
function createGatewayReloadHandlers(params) {
	...
	const markActiveMainSessionsForRestart = async (nextConfig, reason) => {
		...
		const { markRestartAbortedMainSessions } = await import("./main-session-restart-recovery-FE3cfva8.js");
		...
		if (plan.restartGmailWatcher) {
			...
			try {
				if (!restartAbortController.signal.aborted) {
					const [{ stopGmailWatcher }, { startGmailWatcherWithLogs }] = await Promise.all([import("./gmail-watcher-B2RJfulT.js"), import("./gmail-watcher-lifecycle-Dkg6iU7k.js")]);
