...
import { c as readErrorName } from "./errors-BXgSefBE.js";
...
import { a as resolveSessionTranscriptFile, i as readTailAssistantTextFromSessionTranscript, s as appendSessionTranscriptMessage } from "./transcript-Cw-EfeYD.js";
...
import { r as formatAcpErrorChain } from "./errors-B_W4aC5J.js";
import "./errors-xz3P9oAm.js";
import { n as annotateInterSessionPromptText } from "./input-provenance-CYQvfQZP.js";
import { t as FailoverError } from "./failover-error-DAwMDmz6.js";
import { a as resolveCliRuntimeExecutionProvider } from "./model-runtime-aliases-6XX4uD6a.js";
import { T as timestampOptsFromConfig, t as resolveAvailableAgentHarnessPolicy, w as injectTimestamp } from "./selection-BP0T9R9I.js";
import "./workspace-_gXfieOh.js";
import { t as appendUserTurnTranscriptMessage } from "./user-turn-transcript-BKLlhoCh.js";
import { V as buildUsageWithNoCost } from "./compaction-successor-transcript-ONv2lneO.js";
import { t as normalizeReplyPayload } from "./normalize-reply-BJvr7poh.js";
...
import { a as resolveFallbackRetryPrompt, n as claudeCliSessionTranscriptHasContent, t as buildClaudeCliFallbackContextPrelude } from "./attempt-execution.helpers-CPoC_qYr.js";
...
import { n as persistSessionEntry } from "./run-context-BebY4598.js";
import { t as clearCliSessionInStore } from "./session-store-D7_qqNTY.js";
...
async function persistTextTurnTranscript(params) {
	...
	try {
		...
		if (wroteTranscript) transcriptMarkerUpdatedAt = Date.now();
	} finally {
		await lock.release();
	}
	let updatedSessionEntry = sessionEntry;
	if (params.sessionStore && params.storePath && transcriptMarkerUpdatedAt !== void 0) {
		if ((params.sessionStore[params.sessionKey] ?? sessionEntry)?.sessionId === params.sessionId) updatedSessionEntry = await persistSessionEntry({
			sessionStore: params.sessionStore,
			sessionKey: params.sessionKey,
			storePath: params.storePath,
			entry: {
...
function runAgentAttempt(params) {
	...
	if (!isRawModelRun && isCliProvider(cliExecutionProvider, params.cfg)) {
		...
		const runCliWithSession = (nextCliSessionId, activeCliSessionBinding = cliSessionBinding) => runCliAgent({
			...
			reasoningLevel: params.resolvedThinkLevel && params.resolvedThinkLevel !== "off" ? "stream" : "off",
