...
function loadSkillsModule() {
	skillsModulePromise ??= import("./workspace-sOaHXEcp.js");
...
function loadAgentScopeModule() {
	agentScopeModulePromise ??= import("./agent-scope-Do4dPjL6.js");
	return agentScopeModulePromise;
}
function loadAgentWorkspaceDirsModule() {
	agentWorkspaceDirsModulePromise ??= import("./workspace-dirs-MnyuxGNj.js");
...
function loadSkillScannerModule() {
	skillScannerModulePromise ??= import("./scanner-BaQVTEfN.js");
	return skillScannerModulePromise;
}
async function loadExecDockerRaw() {
	sandboxDockerModulePromise ??= import("./docker-Dxz3iy8H.js");
...
async function loadSandboxBrowserSecurityHashEpoch() {
	sandboxConstantsModulePromise ??= import("./constants-oPqiGil8.js");
