import { a as parseCrestodianOperation, t as describeCrestodianPersistentOperation } from "./operations-B8_IoqaI.js";
import { r as loadCrestodianOverview } from "./overview-DagrVfRA.js";
...
async function resolveCrestodianOperation(input, runtime, opts) {
	...
	const plan = await (opts.planWithAssistant ?? (await import("./assistant-CR63AR1Q.js")).planCrestodianCommand)({
		input,
		overview
	});
