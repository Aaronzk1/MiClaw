...
import { a as isGatewayConnectAssemblyError, n as GatewayClient, u as loadDeviceAuthToken } from "./client-C2g2lFC5.js";
...
import { t as canSkipGatewayConfigLoad } from "./explicit-connection-policy-pRPGrlMn.js";
...
async function readGatewayDispatchConfigWithShellEnvFallback(options = {}) {
	...
	const { loadShellEnvFallback, resolveShellEnvFallbackTimeoutMs, shouldDeferShellEnvFallback, shouldEnableShellEnvFallback } = await import("./shell-env-CB1dlcF1.js");
...
const defaultGetRuntimeConfig = async () => (await import("./io-BYWoyJ4I.js")).getRuntimeConfig();
