...
import { r as classifyOAuthRefreshFailure } from "./oauth-refresh-failure-C54bUOW9.js";
...
import { _ as isRateLimitErrorMessage, a as formatTransportErrorCopy, b as matchesFormatErrorPattern, c as isLikelyHttpErrorText, f as isAuthErrorMessage, g as isPeriodicUsageLimitErrorMessage, h as isOverloadedErrorMessage, i as formatRateLimitOrOverloadedErrorCopy, l as isRawApiErrorPayload, m as isBillingErrorMessage, n as formatBillingErrorMessage, p as isAuthPermanentErrorMessage, r as formatDiskSpaceErrorCopy, s as isInvalidStreamingEventOrderError, u as isStreamingJsonParseError, v as isServerErrorMessage, x as formatExecDeniedUserMessage, y as isTimeoutErrorMessage } from "./sanitize-user-facing-text-DDpUeAo_.js";
import { t as formatSandboxToolPolicyBlockedMessage } from "./runtime-status-DNNoBvYA.js";
...
function classifyFailoverSignal(signal) {
	...
	const effectiveMessageClassification = providerPluginReason ? toReasonClassification(providerPluginReason) : messageClassification;
...
//#endregion
export { parseImageDimensionError as C, isUnclassifiedNoBodyHttpSignal as S, isModelNotFoundErrorMessage as T, isImageSizeError as _, extractObservedOverflowTokenCount as a, isReasoningConstraintErrorMessage as b, inferSignalStatus as c, isCloudCodeAssistFormatError as d, isCompactionFailureError as f, isImageDimensionErrorMessage as g, isFailoverErrorMessage as h, classifyProviderRuntimeFailureKind as i, isAuthAssistantError as l, isFailoverAssistantError as m, classifyFailoverReason as n, formatAssistantErrorText as o, isContextOverflowError as p, classifyFailoverSignal as r, formatUserFacingAssistantErrorText as s, GENERIC_ASSISTANT_ERROR_TEXT as t, isBillingAssistantError as u, isLikelyContextOverflowError as v, parseImageSizeError as w, isTransientHttpError as x, isRateLimitAssistantError as y };
