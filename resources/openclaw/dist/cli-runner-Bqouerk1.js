...
import { h as isFailoverErrorMessage, n as classifyFailoverReason } from "./errors-B5Da2wE-.js";
import { o as isFailoverError, t as FailoverError, u as resolveFailoverStatus } from "./failover-error-DAwMDmz6.js";
...
import { n as runAgentEndSideEffects, t as awaitAgentEndSideEffects } from "./agent-end-side-effects-Ba50U1Ua.js";
import { a as runAgentHarnessLlmInputHook, o as runAgentHarnessLlmOutputHook, s as buildAgentHookContext } from "./lifecycle-hook-helpers-BiRlZKs7.js";
import { a as finalizeHarnessContextEngineTurn, n as bootstrapHarnessContextEngine, s as runHarnessContextEngineMaintenance } from "./context-engine-lifecycle-CVy46YJP.js";
import { i as formatCliBackendOutputDigest, r as cliBackendLog } from "./log-RtgQ_MP8.js";
import { d as loadCliSessionHistoryMessages, m as buildAgentHookConversationMessages, n as claudeCliSessionTranscriptHasContent, u as loadCliSessionContextEngineMessages } from "./attempt-execution.helpers-CPoC_qYr.js";
...
async function runCliAgent(params) {
	...
	try {
		...
		if (params.cleanupCliLiveSessionOnRunEnd === true) {
			const { closeClaudeLiveSessionForContext } = await import("./claude-live-session-CGubx1by.js");
