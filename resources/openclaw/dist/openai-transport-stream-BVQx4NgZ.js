...
import { o as withTrustedEnvProxyGuardedFetchMode, r as fetchWithSsrFGuard } from "./fetch-guard-BttkNCLm.js";
import { r as sanitizeInlineImageDataUrl } from "./inline-image-data-url-CwAAaSvc.js";
import { F as resolveProviderTransportTurnStateWithPlugin } from "./provider-runtime-CJtW0nDR.js";
...
import { a as mergeModelProviderRequestOverrides, i as getModelProviderRequestTransport, l as resolveProviderRequestPolicyConfig, r as buildProviderRequestDispatcherPolicy } from "./provider-request-config-0Zg8QIAI.js";
import { t as redactIdentifier } from "./redact-identifier-CXp_wA0R.js";
import { n as repairToolUseResultPairing } from "./session-transcript-repair-B17NYGhL.js";
...
import { l as detectOpenAICompletionsCompat } from "./provider-model-compat-DhKi-Qv5.js";
...
import { i as createReasoningTagTextPartitioner, t as convertMessages } from "./openai-completions-DObeyZ3K.js";
import { t as clampOpenAIPromptCacheKey } from "./openai-prompt-cache-Bx1f-UHU.js";
import { c as isResponsesTextContentPartType, i as resolveOpenAIStrictToolSetting, l as isResponsesTextDeltaEventType, n as normalizeOpenAIStrictToolParameters, r as resolveOpenAIStrictToolFlagForInventory, t as findOpenAIStrictToolSchemaDiagnostics } from "./openai-tool-schema-CT6-f1IZ.js";
import { r as resolveDebugProxySettings } from "./env-ckWue_wY.js";
import { g as truncateErrorDetail, h as readResponseTextLimited, t as ProviderHttpError } from "./provider-http-errors-DqaqQLLZ.js";
import { n as ensureModelProviderLocalService } from "./provider-local-service-ZBHHbJ8A.js";
...
function buildOpenAICompletionsParams(model, context, options) {
	...
	}
	{
		...
		// Xiaomi proxy caps output at 131072 tokens
		const isXiaomiProxy = model.provider === "xiaomi" || (model.baseUrl && model.baseUrl.includes("xiaomimimo.com"));
		if (isXiaomiProxy && clampedMaxTokens !== void 0 && clampedMaxTokens > 131072) {
			clampedMaxTokens = 131072;
		}
