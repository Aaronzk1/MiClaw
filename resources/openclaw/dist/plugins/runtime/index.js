...
import { _ as normalizeLogLevel, r as getChildLogger } from "../../logger-Brhy0cvC.js";
...
import { a as shouldLogVerbose } from "../../globals-GTrXU4s9.js";
...
import { c as resolveThinkingProfile, p as normalizeThinkLevel } from "../../thinking-OG7pb4lf.js";
import { i as replaceConfigFile, n as mutateConfigFile } from "../../config-C9RxTsn1.js";
import { l as onAgentEvent } from "../../agent-events-C1B8VhOg.js";
...
import { a as patchSessionEntry, d as updateSessionStore, f as updateSessionStoreEntry, i as listSessionEntries, l as saveSessionStore, p as upsertSessionEntry, r as getSessionEntry } from "../../store-Qsgtu-0y.js";
...
import { r as buildConfiguredModelCatalog } from "../../model-selection-shared-b32cUYts.js";
...
import { B as resumeFlow, N as finishFlow, O as createManagedTaskFlow, R as requestFlowCancel, V as setFlowWaiting, j as failFlow, m as listTasksForFlowId } from "../../task-registry-FH-Ti23C.js";
import { n as summarizeTaskRecords } from "../../task-registry.summary-BwpoHlXv.js";
import "../../runtime-internal-DmbNZJaP.js";
import { _ as resolveTaskFlowForLookupTokenForOwner, d as runTaskInFlowForOwner, g as listTaskFlowsForOwner, h as getTaskFlowByIdForOwner, l as getFlowTaskSummary, m as findLatestTaskFlowForOwner, r as cancelFlowByIdForOwner, t as cancelDetachedTaskRunById } from "../../task-executor-rbzfy5mW.js";
import { t as resolveAgentTimeoutMs } from "../../timeout-Drw0_zOv.js";
import { a as generateMusic, o as listRuntimeMusicGenerationProviders } from "../../openclaw-tools-C0nKaVVY.js";
...
import { a as getTaskByIdForOwner, o as listTasksForRelatedSessionKeyForOwner, r as findLatestTaskForRelatedSessionKeyForOwner, s as resolveTaskForLookupTokenForOwner } from "../../task-owner-access-2_OeLR-p.js";
import { t as RequestScopedSubagentRuntimeError } from "../../error-runtime-C8vbtAJt.js";
import { g as isVoiceCompatibleAudio } from "../../media-runtime-fgpmX6eL.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "../../runtime-CKbBHWpE.js";
import { a as runWebSearch, r as listWebSearchProviders } from "../../runtime-B83FaW0j.js";
...
import { t as createRuntimeChannel } from "../../runtime-channel-DiQw75-a.js";
...
const loadEmbeddedAgentRuntime = createLazyRuntimeModule(() => import("../../runtime-embedded-agent.runtime-CqLmrmP8.js"));
...
const runHeartbeatOnceInternal = createLazyRuntimeMethod(createLazyRuntimeModule(() => import("../../heartbeat-runner-BGNR7B1H.js")), (runtime) => runtime.runHeartbeatOnce);
...
const loadTtsRuntime = createLazyRuntimeModule(() => import("../../tts-BTZj5Oz-.js"));
const loadMediaUnderstandingRuntime = createLazyRuntimeModule(() => import("../../runtime-C2mBb0dQ.js"));
const loadModelAuthRuntime = createLazyRuntimeModule(() => import("../../runtime-model-auth.runtime-BTb8A4ZF.js"));
...
function createRuntimeLlmFacade() {
	const loadLlm = createLazyRuntimeSurface(() => import("../../runtime-llm.runtime-B6UnEz-T.js"), (m) => m.createRuntimeLlm({
