...
import { t as formatLiteralProviderPrefixedModelRef } from "./model-ref-shared-CqcindZs.js";
import "./workspace-B0bmoo98.js";
import { r as resolveManifestProviderAuthChoice } from "./provider-auth-choices-DutQIlQj.js";
import { t as applyAuthProfileConfig } from "./provider-auth-helpers-BgLOn-Ws.js";
import { n as t } from "./i18n-7g_f4oaD.js";
import { n as openUrl } from "./browser-open-dLnrbzcu.js";
import { n as resolveProviderInstallCatalogEntry } from "./provider-install-catalog-BSmVuCKR.js";
import { n as applyProviderAuthConfigPatch, t as applyDefaultModel } from "./provider-auth-choice-helpers-CewNDs91.js";
...
async function applyDefaultModelFromAuthChoice(params) {
	...
	if (!preservesDifferentPrimary) {
		const { CODEX_RUNTIME_PLUGIN_ID, ensureCodexRuntimePluginForModelSelection } = await import("./codex-runtime-plugin-install-D_mWP3Wr.js");
		...
		const { ensureCopilotRuntimePluginForModelSelection } = await import("./copilot-runtime-plugin-install-Ccrkxg4f.js");
...
async function applyAuthChoiceLoadedPluginProvider(params) {
	...
	if (!resolved && installCatalogEntry) {
		const { ensureOnboardingPluginInstalled } = await import("./onboarding-plugin-install-BUxF5iVm.js");
